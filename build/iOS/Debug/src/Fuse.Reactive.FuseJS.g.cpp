...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.6.0/FuseJS/Http.uno
// -----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.6.0/FuseJS/Builtins.uno
// ---------------------------------------------------------------------------------
...
{
    type->SetFields(0,
        ::g::Fuse::Scripting::Function_typeof(), offsetof(Builtins, Observable), 0,
        ::g::Fuse::Scripting::Function_typeof(), offsetof(Builtins, TreeObservable), 0,
        ::g::Fuse::Scripting::Function_typeof(), offsetof(Builtins, Date), 0,
        ::g::Fuse::Scripting::Function_typeof(), offsetof(Builtins, DateCtor), 0);
}
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.6.0/FuseJS/Timer.uno
// ------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.6.0/FuseJS/DiagnosticsImpl.uno
// ----------------------------------------------------------------------------------------
...
static void DiagnosticsImplModule_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.6.0/FuseJS/DiagnosticsImpl.uno");
...
uObject* DiagnosticsImplModule::Report(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    int32_t type = (::g::Fuse::Marshal__ToType_fn(::TYPES[1/*Fuse.Marshal.ToType<Fuse.DiagnosticType>*/], uPtr(args)->Strong<uObject*>(0), &ret2), ret2);
...
void Http__FuseJSHttpClient::ctor_(::g::Fuse::Scripting::Context* context)
{
    ...
    uPtr(Obj())->Item(::STRINGS[7/*"createRequest"*/], uDelegate::New(::TYPES[3/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpClient__CreateRequest_fn, this));
}
...
static void Http__FuseJSHttpRequest_build(uType* type)
{
    ...
    ::STRINGS[22] = uString::Const("This operation is illegal after request has finished");
    ::STRINGS[23] = uString::Const("Unable to get header.");
    ::STRINGS[24] = uString::Const("onabort");
    ::STRINGS[25] = uString::Const("ondone");
    ::STRINGS[26] = uString::Const("onerror");
    ::STRINGS[27] = uString::Const("onprogress");
    ::STRINGS[28] = uString::Const("onstatechanged");
    ::STRINGS[29] = uString::Const("ontimeout");
    ::STRINGS[30] = uString::Const("buffer");
    ::TYPES[5] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Net::Http::HttpMessageHandlerRequest_typeof(), NULL);
    ::TYPES[6] = ::g::Uno::Action2_typeof()->MakeType(::g::Uno::Net::Http::HttpMessageHandlerRequest_typeof(), ::g::Uno::String_typeof(), NULL);
    ::TYPES[7] = ::g::Uno::Action4_typeof()->MakeType(::g::Uno::Net::Http::HttpMessageHandlerRequest_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Bool_typeof(), NULL);
    ::TYPES[3] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[8] = ::g::Fuse::Scripting::JSCallback_typeof()->MakeMethod(0/*FromAction<int>*/, ::g::Uno::Int_typeof(), NULL);
    ::TYPES[9] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Int_typeof(), NULL);
    ::TYPES[10] = ::g::Uno::Action_typeof();
    ::TYPES[11] = ::g::Fuse::Scripting::JSCallback_typeof()->MakeMethod(1/*FromAction<string, string>*/, ::g::Uno::String_typeof(), ::g::Uno::String_typeof(), NULL);
    ::TYPES[12] = ::g::Uno::Action2_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::String_typeof(), NULL);
    ::TYPES[13] = ::g::Fuse::Scripting::JSCallback_typeof()->MakeMethod(3/*FromFunc<string, string>*/, ::g::Uno::String_typeof(), ::g::Uno::String_typeof(), NULL);
    ::TYPES[14] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::String_typeof(), NULL);
    ::TYPES[15] = ::g::Fuse::Scripting::JSCallback_typeof()->MakeMethod(2/*FromFunc<string>*/, ::g::Uno::String_typeof(), NULL);
    ::TYPES[16] = ::g::Uno::Func_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[17] = ::g::Fuse::Scripting::JSCallback_typeof()->MakeMethod(2/*FromFunc<int>*/, ::g::Uno::Int_typeof(), NULL);
    ::TYPES[18] = ::g::Uno::Func_typeof()->MakeType(::g::Uno::Int_typeof(), NULL);
    ::TYPES[19] = ::g::Uno::Exception_typeof();
    ::TYPES[20] = ::g::Uno::Byte_typeof()->Array();
    ::TYPES[4] = ::g::Uno::String_typeof();
    ::TYPES[21] = ::g::Fuse::Scripting::Function_typeof();
    ...
    type->SetFields(0,
        ...
        ::TYPES[4/*string*/], offsetof(Http__FuseJSHttpRequest, _cachedResponseHeaders), 0,
        uObject_typeof(), offsetof(Http__FuseJSHttpRequest, _cachedResponseContent), 0,
        ::TYPES[24/*int*/], offsetof(Http__FuseJSHttpRequest, _cachedResponseStatus), 0,
        ...
        ::TYPES[23/*Fuse.Scripting.Object*/], offsetof(Http__FuseJSHttpRequest, _Obj), 0);
}
...
void Http__FuseJSHttpRequest::ctor_(::g::Fuse::Scripting::Context* context, ::g::Uno::Net::Http::HttpMessageHandlerRequest* req)
{
    ...
    _req = req;
    Obj(uPtr(context)->NewObject());
    uPtr(_req)->add_Aborted(uDelegate::New(::TYPES[5/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/], (void*)Http__FuseJSHttpRequest__OnAbort_fn, this));
    uPtr(_req)->add_Error(uDelegate::New(::TYPES[6/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, string>*/], (void*)Http__FuseJSHttpRequest__OnError_fn, this));
    uPtr(_req)->add_Timeout(uDelegate::New(::TYPES[5/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/], (void*)Http__FuseJSHttpRequest__OnTimeout_fn, this));
    uPtr(_req)->add_Done(uDelegate::New(::TYPES[5/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/], (void*)Http__FuseJSHttpRequest__OnDone_fn, this));
    uPtr(_req)->add_StateChanged(uDelegate::New(::TYPES[5/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/], (void*)Http__FuseJSHttpRequest__OnStateChanged_fn, this));
    uPtr(_req)->add_Progress(uDelegate::New(::TYPES[7/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, int, int, bool>*/], (void*)Http__FuseJSHttpRequest__OnProgress_fn, this));
    uPtr(Obj())->Item(::STRINGS[8/*"enableCache"*/], uDelegate::New(::TYPES[3/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__EnableCache_fn, this));
    uPtr(Obj())->Item(::STRINGS[9/*"setTimeout"*/], ::g::Fuse::Scripting::JSCallback::FromAction1(::TYPES[8/*Fuse.Scripting.JSCallback.FromAction<int>*/], uDelegate::New(::TYPES[9/*Uno.Action<int>*/], (void*)Http__FuseJSHttpRequest__SetTimeout_fn, this)));
    uPtr(Obj())->Item(::STRINGS[10/*"setResponse...*/], uDelegate::New(::TYPES[3/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__SetResponseType_fn, this));
    uPtr(Obj())->Item(::STRINGS[11/*"getResponse...*/], uDelegate::New(::TYPES[3/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__GetResponseType_fn, this));
    uPtr(Obj())->Item(::STRINGS[12/*"sendAsync"*/], uDelegate::New(::TYPES[3/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__SendAsync_fn, this));
    uPtr(Obj())->Item(::STRINGS[13/*"abort"*/], ::g::Fuse::Scripting::JSCallback::FromAction(uDelegate::New(::TYPES[10/*Uno.Action*/], (void*)Http__FuseJSHttpRequest__Abort_fn, this)));
    uPtr(Obj())->Item(::STRINGS[14/*"setHeader"*/], ::g::Fuse::Scripting::JSCallback::FromAction2(::TYPES[11/*Fuse.Scripting.JSCallback.FromAction<string, string>*/], uDelegate::New(::TYPES[12/*Uno.Action<string, string>*/], (void*)Http__FuseJSHttpRequest__SetHeader_fn, this)));
    uPtr(Obj())->Item(::STRINGS[15/*"getResponse...*/], ::g::Fuse::Scripting::JSCallback::FromFunc1(::TYPES[13/*Fuse.Scripting.JSCallback.FromFunc<string, string>*/], uDelegate::New(::TYPES[14/*Uno.Func<string, string>*/], (void*)Http__FuseJSHttpRequest__GetResponseHeader_fn, this)));
    uPtr(Obj())->Item(::STRINGS[16/*"getResponse...*/], ::g::Fuse::Scripting::JSCallback::FromFunc(::TYPES[15/*Fuse.Scripting.JSCallback.FromFunc<string>*/], uDelegate::New(::TYPES[16/*Uno.Func<string>*/], (void*)Http__FuseJSHttpRequest__GetResponseHeaders_fn, this)));
    uPtr(Obj())->Item(::STRINGS[17/*"getState"*/], uDelegate::New(::TYPES[3/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__GetState_fn, this));
    uPtr(Obj())->Item(::STRINGS[18/*"getResponse...*/], ::g::Fuse::Scripting::JSCallback::FromFunc(::TYPES[17/*Fuse.Scripting.JSCallback.FromFunc<int>*/], uDelegate::New(::TYPES[18/*Uno.Func<int>*/], (void*)Http__FuseJSHttpRequest__GetResponseStatus_fn, this)));
    uPtr(Obj())->Item(::STRINGS[19/*"getResponse...*/], uDelegate::New(::TYPES[3/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__GetResponseReasonPhrase_fn, this));
    uPtr(Obj())->Item(::STRINGS[20/*"getResponse...*/], uDelegate::New(::TYPES[3/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__GetResponseContentString_fn, this));
    uPtr(Obj())->Item(::STRINGS[21/*"getResponse...*/], uDelegate::New(::TYPES[3/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__GetResponseContentByteArray_fn, this));
}
...
{
    if (_req == NULL)
        U_THROW(::g::Uno::InvalidOperationException::New5(::STRINGS[22/*"This operat...*/]));
}
...
void Http__FuseJSHttpRequest::DetachRequest()
{
    ...
    uPtr(_req)->remove_Aborted(uDelegate::New(::TYPES[5/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/], (void*)Http__FuseJSHttpRequest__OnAbort_fn, this));
    uPtr(_req)->remove_Error(uDelegate::New(::TYPES[6/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, string>*/], (void*)Http__FuseJSHttpRequest__OnError_fn, this));
    uPtr(_req)->remove_Timeout(uDelegate::New(::TYPES[5/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/], (void*)Http__FuseJSHttpRequest__OnTimeout_fn, this));
    uPtr(_req)->remove_Done(uDelegate::New(::TYPES[5/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/], (void*)Http__FuseJSHttpRequest__OnDone_fn, this));
    uPtr(_req)->remove_StateChanged(uDelegate::New(::TYPES[5/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/], (void*)Http__FuseJSHttpRequest__OnStateChanged_fn, this));
    uPtr(_req)->remove_Progress(uDelegate::New(::TYPES[7/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, int, int, bool>*/], (void*)Http__FuseJSHttpRequest__OnProgress_fn, this));
    uPtr(_req)->Dispose();
    _req = NULL;
    Obj(NULL);
}
...
uObject* Http__FuseJSHttpRequest::GetResponseContentByteArray(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    uArray* contentAsBytes = uAs<uArray*>(_cachedResponseContent, ::TYPES[20/*byte[]*/]);
...
uString* Http__FuseJSHttpRequest::GetResponseContentString(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    uString* contentAsString = uAs<uString*>(_cachedResponseContent, ::TYPES[4/*string*/]);
...
uString* Http__FuseJSHttpRequest::GetResponseHeader(uString* key)
{
    ...
    if (::g::Uno::String::op_Equality(_cachedResponseHeaders, NULL))
        U_THROW(::g::Uno::InvalidOperationException::New5(::STRINGS[23/*"Unable to g...*/]));
...
{
    if (_req == NULL)
        return uBox<int32_t>(::TYPES[24/*int*/], _cachedResponseType);

    return uBox<int32_t>(::TYPES[24/*int*/], uPtr(_req)->HttpResponseType());
}
...
{
    return uBox<int32_t>(::TYPES[24/*int*/], (_req != NULL) ? uPtr(_req)->State() : _finalState);
}
...
{
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(uPtr(Obj())->Item(::STRINGS[24/*"onabort"*/]), ::TYPES[21/*Fuse.Scripting.Function*/]);

    if (func != NULL)
        uPtr(func)->Call(_context, uArray::New(::TYPES[22/*object[]*/], 0));
...
{
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(uPtr(Obj())->Item(::STRINGS[25/*"ondone"*/]), ::TYPES[21/*Fuse.Scripting.Function*/]);
...
{
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(uPtr(Obj())->Item(::STRINGS[26/*"onerror"*/]), ::TYPES[21/*Fuse.Scripting.Function*/]);

    if (func != NULL)
        uPtr(func)->Call(_context, uArray::Init<uObject*>(::TYPES[22/*object[]*/], 1, error));
...
{
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(uPtr(Obj())->Item(::STRINGS[27/*"onprogress"*/]), ::TYPES[21/*Fuse.Scripting.Function*/]);

    if (func != NULL)
        uPtr(func)->Call(_context, uArray::Init<uObject*>(::TYPES[22/*object[]*/], 3, uBox<int32_t>(::TYPES[24/*int*/], current), uBox<int32_t>(::TYPES[24/*int*/], total), uBox(::g::Uno::Bool_typeof(), hastotal)));
}
...
{
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(uPtr(Obj())->Item(::STRINGS[28/*"onstatechan...*/]), ::TYPES[21/*Fuse.Scripting.Function*/]);

    if (func != NULL)
        uPtr(func)->Call(_context, uArray::Init<uObject*>(::TYPES[22/*object[]*/], 1, uBox<int32_t>(::TYPES[24/*int*/], uPtr(_req)->State())));
}
...
{
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(uPtr(Obj())->Item(::STRINGS[29/*"ontimeout"*/]), ::TYPES[21/*Fuse.Scripting.Function*/]);
...
uObject* Http__FuseJSHttpRequest::SendAsync(::g::Fuse::Scripting::Context* context, uArray* args)
{
    if ((args != NULL) && (uPtr(args)->Length() > 0))
    {
        ...
        if (uIs(a, ::TYPES[4/*string*/]))
        {
            uPtr(_req)->SendAsync2(uAs<uString*>(a, ::TYPES[4/*string*/]));
            return NULL;
        }
        else if (uIs(a, ::TYPES[20/*byte[]*/]))
        {
            uArray* b = uAs<uArray*>(a, ::TYPES[20/*byte[]*/]);
        ...
        else
        {
            ...
            if ((obj != NULL) && (uPtr(obj)->Item(::STRINGS[30/*"buffer"*/]) != NULL))
            {
                uArray* b1 = uAs<uArray*>(uPtr(obj)->Item(::STRINGS[30/*"buffer"*/]), ::TYPES[20/*byte[]*/]);
...
uObject* Http__FuseJSHttpRequest::SetResponseType(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    if (uPtr(args)->Length() > 0)
    {
        ...
        int32_t value = uIs(arg, ::TYPES[24/*int*/]) ? uUnbox<int32_t>(::TYPES[24/*int*/], arg) : (int32_t)uUnbox<double>(::g::Uno::Double_typeof(), arg);
...
{
    uPtr(uPtr(result)->GetObject(c))->Item(uString::Const("exports"), uDelegate::New(::TYPES[3/*Fuse.Scripting.Callback*/], (void*)Http__CreateClient_fn, __this));
}
...
static void HttpHeaders_build(uType* type)
{
    ...
    type->SetFields(0,
        ::TYPES[25/*Uno.Collections.Dictionary<string, Uno.Collections.IList<string>>*/], offsetof(HttpHeaders, _headers), 0);
}
...
uString* HttpHeaders::GetValue(uString* key)
{
    ...
    if ((::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(_headers), ::g::Uno::String::ToLower(uPtr(key)), (void**)(&list), &ret6), ret6))
        return ::g::Uno::String::Join(::STRINGS[31/*", "*/], (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[27/*Uno.Collections.EnumerableExtensions.ToArray<string>*/], list));
...
void HttpHeaders::ParseHeader(uString* headerLine)
{
    ...
    uArray* strings = ::g::Uno::String::Split(uPtr(::g::Uno::String::Trim(uPtr(::g::Uno::String::Substring1(headerLine, colon + 1, headerLine->Length() - (colon + 1))))), uArray::Init<int32_t>(::TYPES[28/*char[]*/], 1, ';'));
    ...
    if ((::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(_headers), name, &ret7), ret7))
    {
...

        {
            ...
            {
                {
                    while (enum4.MoveNext(::TYPES[30/*Uno.Collections.List<string>.Enumerator*/]))
                    {
            ...
            {
                {
                    enum4.Dispose(::TYPES[30/*Uno.Collections.List<string>.Enumerator*/]);
                }
                                throw __t;
...
int32_t TimerManager::AddTimer(double ms, uDelegate* callback, bool repeat)
{
    ...
    t->OnStop = uDelegate::New(::TYPES[9/*Uno.Action<int>*/], (void*)TimerManager__RemoveTimer_fn, this);
...
uObject* TimerModule::Create(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    if (!uIs((uObject*)uPtr(args)->Strong<uObject*>(0), ::TYPES[21/*Fuse.Scripting.Function*/]))
        U_THROW(::g::Fuse::Scripting::Error::New4(uString::Const("create(): first argument must be a function")));

    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[21/*Fuse.Scripting.Function*/]);
    ...
    return uBox<int32_t>(::TYPES[24/*int*/], uPtr(_tm)->AddTimer(ms, uDelegate::New(::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), NULL), (void*)TimerModule__CallbackClosure__Callback_fn, TimerModule__CallbackClosure::New1(context, func, innerArgs)), repeat));
}
...
uObject* TimerModule::Delete(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::g::Fuse::MarshalException_typeof()))
        {
            ...
            ::g::Fuse::Diagnostics::UserWarning(uString::Const("Timer.delete(): The parameter is not a valid timer handle"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.6.0/FuseJS/Timer.uno"), 133, uString::Const("Delete"));
        }
        else         throw __t;
    }
