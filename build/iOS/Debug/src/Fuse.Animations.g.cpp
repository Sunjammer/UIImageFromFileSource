...
// /usr/local/share/uno/Packages/Fuse.Animations/1.6.0/TriggerAnimation.uno
// ------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.6.0/Animator.uno
// ----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.6.0/Attract.uno
// ---------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.6.0/Attractor.uno
// -----------------------------------------------------------------
...
static void Attractor_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/1.6.0/Attractor.uno");
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.6.0/AverageMixer.uno
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Common/1.6.0/Easing.uno
// ----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.6.0/Change.uno
// --------------------------------------------------------------
...
static void ContinuousTrackChangeState_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/1.6.0/Change.uno");
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.6.0/TrackAnimator.uno
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.6.0/Cycle.uno
// -------------------------------------------------------------
...
static void CycleState_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/1.6.0/Cycle.uno");
    ::TYPES[11] = ::g::Fuse::Animations::IMixer_typeof();
    ::TYPES[4] = ::g::Fuse::Internal::BlenderMap_typeof();
    ::TYPES[12] = ::g::Fuse::Animations::IMixerHandle_typeof();
    type->SetDependencies(
...
void CycleState__Seek_fn(CycleState* __this, bool* on, float* interval, float* strength, int32_t* dir, bool* __retval)
{
    ...
    if (__this->mixHandle == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log3(::STRINGS[7/*"Invalid seek"*/], 0, ::STRINGS[8/*"/usr/local/...*/], 258);
...
// /usr/local/share/uno/Packages/Fuse.Motion/1.6.0/DestinationBehavior.uno
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.6.0/DiscreteMixer.uno
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.6.0/DiscreteSingleTrack.uno
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.6.0/EasingTrack.uno
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.6.0/Mixer.uno
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.6.0/Resize.uno
// --------------------------------------------------------------
...
static void MasterProperty_build(uType* type)
{
    ...
    ::STRINGS[12] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/1.6.0/Mixer.uno");
...
void MixerHandle__Set_fn(MixerHandle* __this, void* value, float* strength)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log3(::STRINGS[14/*"invalid Mix...*/], 0, ::STRINGS[12/*"/usr/local/...*/], 392);
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.6.0/TransformAnimator.uno
// -------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.6.0/Nothing.uno
// ---------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.6.0/OpenAnimator.uno
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.6.0/Player.uno
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.6.0/RangeAdapter.uno
// --------------------------------------------------------------------
...
static void ResizeAnimatorState_build(uType* type)
{
    ...
    ::STRINGS[17] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/1.6.0/Resize.uno");
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.6.0/Spin.uno
// ------------------------------------------------------------
...
{
    ::STRINGS[7] = uString::Const("Invalid seek");
    ::STRINGS[20] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/1.6.0/Spin.uno");
    ::TYPES[11] = ::g::Fuse::Animations::IMixer_typeof();
...
void SpinState__Seek_fn(SpinState* __this, bool* on, float* interval, float* strength, int32_t* dir, bool* __retval)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log3(::STRINGS[7/*"Invalid seek"*/], 0, ::STRINGS[20/*"/usr/local/...*/], 76);
        return *__retval = true, void();
    }
...
static void Attract__Subscription_build(uType* type)
{
    ...
    ::STRINGS[22] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/1.6.0/Attract.uno");
...
void Attract__Subscription::NeedSim(int32_t size)
{
    ...
    if ((size < 0) || (size > 4))
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[21/*"Unexpected ...*/], uBox<int32_t>(::g::Uno::Int_typeof(), size)), this, ::STRINGS[22/*"/usr/local/...*/], 150, ::STRINGS[23/*"NeedSim"*/]);
        return;
    }
...
{
    ::STRINGS[7] = uString::Const("Invalid seek");
    ::STRINGS[24] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/1.6.0/TransformAnimator.uno");
    ::TYPES[11] = ::g::Fuse::Animations::IMixer_typeof();
...
void TransformAnimatorState__SeekValue_fn(TransformAnimatorState* __this, ::g::Uno::Float4* value, float* strength)
{
    ...
    if ((__this->mixHandle == NULL) || (__this->transform == NULL))
    {
        ::g::Uno::Diagnostics::Debug::Log3(::STRINGS[7/*"Invalid seek"*/], 0, ::STRINGS[24/*"/usr/local/...*/], 171);
        return;
    }
