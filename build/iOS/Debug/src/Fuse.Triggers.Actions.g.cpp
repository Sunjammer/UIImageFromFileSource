...
// /usr/local/share/uno/Packages/Fuse.Elements/1.6.0/Triggers/Actions/BringIntoView.uno
// ------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls/1.6.0/Triggers/BringToFront.uno
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Actions/Callback.uno
// ----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Actions/CancelInteractions.uno
// --------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Actions/Visibility.uno
// ------------------------------------------------------------------------
...
static void Collapse_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Actions/Visibility.uno");
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Actions/DebugAction.uno
// -------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Actions/DebugProperty.uno
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.WebView/1.6.0/EvaluateJS.uno
// ------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Actions/Focus.uno
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Actions/Toggle.uno
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.WebView/1.6.0/WebViewNavActions.uno
// -------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Actions/Pulse.uno
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.UserEvents/1.6.0/RaiseUserEvent.uno
// ----------------------------------------------------------------------
...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/1.6.0/RaiseUserEvent.uno");
    ::STRINGS[2] = uString::Const("Perform");
...
// /usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/NavigationActions.uno
// ----------------------------------------------------------------------------------
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/NavigationActions.uno");
    ::STRINGS[2] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Visual>*/, ::g::Fuse::Visual_typeof(), NULL);
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Actions/Set.uno
// -----------------------------------------------------------------
...
void Show__Perform_fn(Show* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[10/*"Cannot find...*/], __this, ::STRINGS[1/*"/usr/local/...*/], 38, ::STRINGS[2/*"Perform"*/], NULL);
}
// }
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Actions/TimelineAction.uno
// ----------------------------------------------------------------------------
...
static void TimelineAction_build(uType* type)
{
    ...
    ::STRINGS[12] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Actions/TimelineAction.uno");
    ::STRINGS[2] = uString::Const("Perform");
    type->SetFields(8,
...
void TimelineAction__Perform_fn(TimelineAction* __this, ::g::Fuse::Node* target)
{
    ...
    if (t == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[11/*"`TimelineAc...*/], __this, ::STRINGS[12/*"/usr/local/...*/], 48, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
static void Toggle_build(uType* type)
{
    ...
    ::STRINGS[14] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Actions/Toggle.uno");
    ::STRINGS[2] = uString::Const("Perform");
...
void Toggle__Perform_fn(Toggle* __this, ::g::Fuse::Node* target)
{
    ...
    if (t == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[13/*"Could not f...*/], __this, ::STRINGS[14/*"/usr/local/...*/], 41, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
static void TransitionLayout_build(uType* type)
{
    ...
    ::STRINGS[16] = uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/1.6.0/Triggers/LayoutAnimation.uno");
    ::STRINGS[2] = uString::Const("Perform");
    ::TYPES[0] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[1] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Visual>*/, ::g::Fuse::Visual_typeof(), NULL);
    ::TYPES[24] = ::g::Uno::Action_typeof();
...
void TransitionLayout__Perform_fn(TransitionLayout* __this, ::g::Fuse::Node* target)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[15/*"Missing `Fr...*/], __this, ::STRINGS[16/*"/usr/local/...*/], 355, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Actions/StateTransition.uno
// -----------------------------------------------------------------------------
...
static void TransitionState_build(uType* type)
{
    ...
    ::STRINGS[18] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Actions/StateTransition.uno");
    ::STRINGS[2] = uString::Const("Perform");
    type->SetFields(8,
...
void TransitionState__Perform_fn(TransitionState* __this, ::g::Fuse::Node* target)
{
    ...
    if (t == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[17/*"Missing `Ta...*/], __this, ::STRINGS[18/*"/usr/local/...*/], 24, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Actions/TriggerAction.uno
// ---------------------------------------------------------------------------
