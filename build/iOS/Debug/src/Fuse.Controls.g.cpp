...
#include <Fuse.Controls.EdgeNavigator.ControlPageData.h>
...
#include <Fuse.Controls.NavigationControl.ControlPageData.h>
#include <Fuse.Controls.NavigationControl.h>
#include <Fuse.Controls.NavigationControl.UpdateFlags.h>
#include <Fuse.Controls.NavigationControlBlockInput.h>
...
#include <Fuse.Controls.Navigator.PrepareResult.h>
...
#include <Fuse.Controls.PageControl.PagesMap.h>
...
#include <Fuse.Controls.ScrollViewPagerArgs.h>
...
// /usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/PageControl.Pages.uno
// ----------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.6.0/Shapes/Arc.uno
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.WebView/1.6.0/WebView.uno
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.6.0/ButtonBase.uno
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.6.0/Shapes/Circle.uno
// ------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls/1.6.0/ContentControl.uno
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls/1.6.0/Control.Background.uno
// ------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/NavigationControl.uno
// ----------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/EdgeNavigator.uno
// ------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.6.0/Shapes/Curve.uno
// -----------------------------------------------------------------------------
...
uObject* Curve::GetSegments()
{
    ...
    int32_t end = (Close() == 2) ? uPtr(_points)->Count() + 1 : uPtr(_points)->Count();

    for (int32_t i = 0; i < end; ++i)
    {
        if (i == 0)
        {
            uPtr(line)->MoveTo(::g::Uno::Float2__op_Multiply2(uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(_points), uCRef<int32_t>(i), &ret3), ret3))->At(), rs));
            continue;
        }

        if (Style() == 0)
        {
            uPtr(line)->LineTo(::g::Uno::Float2__op_Multiply2(uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(_points), uCRef<int32_t>(WrapPointsIndex(i)), &ret4), ret4))->At(), rs));
            continue;
        }

        ::g::Fuse::Controls::CurvePoint* prev = (::g::Uno::Collections::List__get_Item_fn(uPtr(_points), uCRef<int32_t>(WrapPointsIndex(i - 2)), &ret5), ret5);
        ::g::Fuse::Controls::CurvePoint* cur = (::g::Uno::Collections::List__get_Item_fn(uPtr(_points), uCRef<int32_t>(WrapPointsIndex(i - 1)), &ret6), ret6);
        ::g::Fuse::Controls::CurvePoint* next = (::g::Uno::Collections::List__get_Item_fn(uPtr(_points), uCRef<int32_t>(WrapPointsIndex(i)), &ret7), ret7);
        ::g::Fuse::Controls::CurvePoint* next2 = (::g::Uno::Collections::List__get_Item_fn(uPtr(_points), uCRef<int32_t>(WrapPointsIndex(i + 1)), &ret8), ret8);
        ::g::Uno::Float4 ta, tb;
    ...
    if (Extrude() != 0)
    {
        uPtr(line)->LineTo(::g::Uno::Float2__op_Multiply2(ExtrudePoint(uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(_points), uCRef<int32_t>(uPtr(_points)->Count() - 1), &ret9), ret9))->At()), rs));
        line->LineTo(::g::Uno::Float2__op_Multiply2(ExtrudePoint(uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(_points), uCRef<int32_t>(0), &ret10), ret10))->At()), rs));
        line->ClosePath();
    }
    else if (Close() != 0)
        uPtr(line)->ClosePath();
...
// /usr/local/share/uno/Packages/Fuse.Controls.Panels/1.6.0/GraphicsView.ux.uno
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.6.0/.uno/ux13/Fuse.Controls.ScrollView.g.uno
// -----------------------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/Navigator.uno
// --------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/EdgeNavigator.ScriptClass.uno
// ------------------------------------------------------------------------------------------
...
void EdgeNavigator::SetupEdge(EdgeNavigator__ControlPageData* pd, ::g::Fuse::Elements::Element* elm, ::g::Uno::Float2 rel, int32_t align)
{
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(enter->Animators()), ::TYPES[31/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), move);
    uPtr(pd)->Enter = enter;
...
void EdgeNavigator::open(EdgeNavigator* e, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("EdgeNaviagator.open requires 1 parameter (edge)"), e, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/EdgeNavigator.ScriptClass.uno"), 37, uString::Const("open"), NULL);
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.6.0/Shapes/Ellipse.uno
// -------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.6.0/Shapes/EllipticalShape.Surface.uno
// -----------------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Panels/1.6.0/TreeRenderer.iOS.uno
// -----------------------------------------------------------------------------
...
static void Extensions_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Panels/1.6.0/TreeRenderer.iOS.uno");
...
// public static float4 GetColor(Fuse.Drawing.Brush brush) :192
void Extensions__GetColor_fn(::g::Fuse::Drawing::Brush* brush, ::g::Uno::Float4* __retval)
{
    *__retval = Extensions::GetColor(brush);
}

// public static float4 GetColor(Fuse.Drawing.Brush brush) [static] :192
::g::Uno::Float4 Extensions::GetColor(::g::Fuse::Drawing::Brush* brush)
{
    ...
    if (brush != NULL)
    {
        ...
        if ((sc == NULL) && (ssc == NULL))
            ::g::Fuse::Diagnostics::Unsupported(::STRINGS[8/*"Cannot conv...*/], brush, ::STRINGS[9/*"/usr/local/...*/], 205, ::STRINGS[10/*"GetColor"*/]);
    }
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.6.0/Shapes/Path.uno
// ----------------------------------------------------------------------------
...
void GraphicsView::OnEnteringForeground(int32_t s)
{
    ...
    _frameScheduled = false;
    ScheduleFrame();
    ::g::Fuse::UpdateManager::PerformNextFrame(uDelegate::New(::TYPES[34/*Uno.Action*/], (void*)::g::Fuse::Visual__InvalidateVisual_fn, this), 0, 1);
}
...
void GraphicsView::ScheduleFrame()
{
    if (!_frameScheduled)
    {
        ::g::Fuse::UpdateManager::AddOnceAction(uDelegate::New(::TYPES[34/*Uno.Action*/], (void*)GraphicsView__DrawFrame_fn, this), 2);
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.6.0/Image.ScriptClass.uno
// ----------------------------------------------------------------------------------
...
{
    ::g::Fuse::Scripting::ScriptClass_typeof()->Init();
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[19/*Fuse.Scripting.ScriptMember[]*/], 2, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New3(::TYPES[20/*Fuse.Scripting.ScriptMethod<Fuse.Controls.Image>*/], ::STRINGS[12/*"reload"*/], uDelegate::New(::TYPES[21/*Uno.Action<Fuse.Controls.Image>*/], (void*)Image__reload_fn)), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New3(::TYPES[20/*Fuse.Scripting.ScriptMethod<Fuse.Controls.Image>*/], ::STRINGS[13/*"retry"*/], uDelegate::New(::TYPES[21/*Uno.Action<Fuse.Controls.Image>*/], (void*)Image__retry_fn))));
}

static void Image_build(uType* type)
{
    ::STRINGS[12] = uString::Const("reload");
    ::STRINGS[13] = uString::Const("retry");
    ::STRINGS[14] = uString::Const("unknown failure");
    ::STRINGS[11] = uString::Const("");
    ...
    ::TYPES[23] = ::g::Fuse::Controls::Native::IImageView_typeof();
...
// protected override sealed void ArrangePaddingBox(Fuse.LayoutParams lp) :44
...
// protected override sealed Fuse.VisualBounds CalcRenderBounds() :166
...
// protected override sealed float2 GetContentSize(Fuse.LayoutParams lp) :31
...
// private float2 GetSize() :16
void Image__GetSize_fn(Image* __this, ::g::Uno::Float2* __retval)
{
    *__retval = __this->GetSize();
}

// protected override sealed Fuse.VisualBounds get_HitTestLocalVisualBounds() :158
...
// protected override sealed void OnHitTestLocalVisual(Fuse.HitTestContext htc) :146
...
void Image__OnRooted_fn(Image* __this)
{
    ...
    uPtr(__this->_container)->add_SourceError(uDelegate::New(::TYPES[22/*Fuse.Resources.ImageSourceErrorHandler*/], (void*)Image__OnContainerSourceError_fn, __this));
...
void Image__OnUnrooted_fn(Image* __this)
{
    ...
    uPtr(__this->_container)->remove_SourceError(uDelegate::New(::TYPES[22/*Fuse.Resources.ImageSourceErrorHandler*/], (void*)Image__OnContainerSourceError_fn, __this));
...
// internal static float3x3 TransformFromImageOrientation(Fuse.Resources.Exif.ImageOrientation orientation) :89
...
// private void UpdateNativeImageTransform() :66
...
// private void DrawVisualColor(Fuse.DrawContext dc, float4 color) [instance] :123
...
// private float2 GetSize() [instance] :16
...
{
    return uAs<uObject*>(NativeView(), ::TYPES[23/*Fuse.Controls.Native.IImageView*/]);
}
...
void Image::OnSourceChanged()
{
    if (uPtr(_container)->Source() != NULL)
    {
        ...
        ::g::Fuse::Triggers::BusyTask::SetBusy(this, &_loadingTask, _markedFailed ? 16 : isLoading ? 1 : 0, _markedFailed ? (_lastError == NULL) ? ::STRINGS[14/*"unknown fai...*/] : (uString*)uPtr(_lastError)->Reason : ::STRINGS[11/*""*/]);
    }
...
void Image::UpdateNativeImageSource()
{
    ...
    if (imageView != NULL)
    {
        ::g::Fuse::Controls::Native::IImageView::ImageSource(uInterface(uPtr(imageView), ::TYPES[23/*Fuse.Controls.Native.IImageView*/]), Source());
        ::g::Fuse::Controls::Native::IImageView::TintColor(uInterface(uPtr(ImageView()), ::TYPES[23/*Fuse.Controls.Native.IImageView*/]), Color());
    }
}

// private void UpdateNativeImageTransform() [instance] :66
void Image::UpdateNativeImageTransform()
{
    uObject* imageView = ImageView();

    if (imageView != NULL)
        ::g::Fuse::Controls::Native::IImageView::UpdateImageTransform(uInterface(uPtr(imageView), ::TYPES[23/*Fuse.Controls.Native.IImageView*/]), ::g::Fuse::ICommonViewport::PixelsPerPoint(uInterface(uPtr(Viewport()), ::TYPES[24/*Fuse.ICommonViewport*/])), _origin, _scale, _drawSize);
}
...
// internal static float3x3 TransformFromImageOrientation(Fuse.Resources.Exif.ImageOrientation orientation) [static] :89
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.6.0/Image.Visual.uno
// -----------------------------------------------------------------------------

// internal sealed class ImageElementDraw :174
// {
// static generated ImageElementDraw() :174
...
{
    ::STRINGS[15] = uString::Const("Invalid enum value");
    ::STRINGS[16] = uString::Const("resampleMode");
    type->SetDependencies(
...
// public generated ImageElementDraw() :174
void ImageElementDraw__ctor__fn(ImageElementDraw* __this)
{
    __this->ctor_();
}

// public void Draw(Fuse.DrawContext dc, Fuse.Visual element, float2 offset, float2 size, float2 uvPosition, float2 uvSize, float3x3 imageTransform, texture2D tex, Fuse.Drawing.ResampleMode resampleMode, float4 Color) :190
...
// private Uno.Graphics.SamplerState GetSamplerState(Fuse.Drawing.ResampleMode resampleMode) :177
...
// public generated ImageElementDraw New() :174
...
// public generated ImageElementDraw() [instance] :174
void ImageElementDraw::ctor_()
{
}

// public void Draw(Fuse.DrawContext dc, Fuse.Visual element, float2 offset, float2 size, float2 uvPosition, float2 uvSize, float3x3 imageTransform, texture2D tex, Fuse.Drawing.ResampleMode resampleMode, float4 Color) [instance] :190
...
{
    uPtr(::g::Fuse::Drawing::Blitter::Singleton())->Blit(tex, GetSamplerState(resampleMode), false, ::g::Uno::Rect__New2(uvPosition, uvSize), imageTransform, ::g::Uno::Rect__New2(offset, size), uPtr(dc)->GetLocalToClipTransform(element), Color, 0);
}

// private Uno.Graphics.SamplerState GetSamplerState(Fuse.Drawing.ResampleMode resampleMode) [instance] :177
::g::Uno::Graphics::SamplerState ImageElementDraw::GetSamplerState(int32_t resampleMode)
{
    switch (resampleMode)
    {
        ...
        default:
            U_THROW(::g::Uno::ArgumentException::New5(::STRINGS[15/*"Invalid enu...*/], ::STRINGS[16/*"resampleMode"*/]));
    }
}

// public generated ImageElementDraw New() [static] :174
...
// /usr/local/share/uno/Packages/Fuse.Controls.Panels/1.6.0/TreeRendererPanel.uno
// ------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.6.0/TextControls/TextControl.GraphicsText.uno
// ------------------------------------------------------------------------------------------------------
...
void JavaScriptCall::Apply(uObject* wv)
{
    if (::g::Uno::Delegate::op_Inequality(Handler, NULL))
        ::g::Fuse::Controls::IWebView::Eval1(uInterface(uPtr(wv), ::TYPES[25/*Fuse.Controls.IWebView*/]), Script, Handler);
    else
        ::g::Fuse::Controls::IWebView::Eval(uInterface(uPtr(wv), ::TYPES[25/*Fuse.Controls.IWebView*/]), Script);
}
...
// /usr/local/share/uno/Packages/Fuse.Controls.Panels/1.6.0/LayoutControl.Canvas.uno
// ---------------------------------------------------------------------------------
...
{
    ::STRINGS[17] = uString::Const("LayoutControl not properly rooted in Surface");
    ::STRINGS[18] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Panels/1.6.0/LayoutControl.Canvas.uno");
    ::STRINGS[19] = uString::Const("ISurfaceDrawableDraw");
    ::STRINGS[20] = uString::Const("Mismatched surface");
    ::STRINGS[21] = uString::Const("Surface contains a non-drawable child");
...
void LayoutControl::ISurfaceDrawableDraw(::g::Fuse::Drawing::Surface* surface)
{
    if (_surface == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[17/*"LayoutContr...*/], this, ::STRINGS[18/*"/usr/local/...*/], 105, ::STRINGS[19/*"ISurfaceDra...*/]);
        return;
    }

    if (uPtr(_surface)->Surface != surface)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[20/*"Mismatched ...*/], this, ::STRINGS[18/*"/usr/local/...*/], 110, ::STRINGS[19/*"ISurfaceDra...*/]);
    ...
    for (int32_t i = 0; i < uPtr(zOrder)->Length(); i++)
    {
        ...
        uObject* drawable = uAs<uObject*>(child, ::TYPES[26/*Fuse.Drawing.ISurfaceDrawable*/]);

        if (drawable == NULL)
        {
            if (!uPtr(_surface)->WarnDraw)
            {
                ::g::Fuse::Diagnostics::UserWarning(::STRINGS[21/*"Surface con...*/], child, ::STRINGS[18/*"/usr/local/...*/], 144, ::STRINGS[19/*"ISurfaceDra...*/]);
...
{
    ::STRINGS[22] = uString::Const("Prepare without surface");
    ::STRINGS[18] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Panels/1.6.0/LayoutControl.Canvas.uno");
    ::STRINGS[23] = uString::Const("Fuse.Drawing.IDrawObjectWatcherFeedback.Prepare");
    ::STRINGS[24] = uString::Const("Fuse.Drawing.IDrawObjectWatcherFeedback.Unprepare");
    ::TYPES[27] = ::g::Fuse::Drawing::Stroke_typeof();
...
{
    if (uIs(obj, ::TYPES[27/*Fuse.Drawing.Stroke*/]))
...
void LayoutControlSurface__FuseDrawingIDrawObjectWatcherFeedbackPrepare_fn(LayoutControlSurface* __this, uObject* obj)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"Prepare wit...*/], __this, ::STRINGS[18/*"/usr/local/...*/], 34, ::STRINGS[23/*"Fuse.Drawin...*/]);
        return;
    }

    ::g::Fuse::Drawing::Brush* b = uAs< ::g::Fuse::Drawing::Brush*>(obj, ::TYPES[28/*Fuse.Drawing.Brush*/]);
...
void LayoutControlSurface__FuseDrawingIDrawObjectWatcherFeedbackUnprepare_fn(LayoutControlSurface* __this, uObject* obj)
{
    if (__this->Surface == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"Prepare wit...*/], __this, ::STRINGS[18/*"/usr/local/...*/], 47, ::STRINGS[24/*"Fuse.Drawin...*/]);
        return;
    }
...
{
    ::g::Fuse::Controls::IWebView::LoadHtml1(uInterface(uPtr(wv), ::TYPES[25/*Fuse.Controls.IWebView*/]), html, baseUrl);
}
...
// /usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/NavigationControl.BlockInput.uno
// ---------------------------------------------------------------------------------------------
...
static void NavigationControl__cctor_4_fn(uType* __type)
{
    ...
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[19/*Fuse.Scripting.ScriptMember[]*/], 3, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New2(::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(__type, NULL), uString::Const("gotoPath"), uDelegate::New(::g::Uno::Action2_typeof()->MakeType(__type, uObject_typeof()->Array(), NULL), (void*)NavigationControl__gotoPath_fn)), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New2(::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(__type, NULL), uString::Const("seekToPath"), uDelegate::New(::g::Uno::Action2_typeof()->MakeType(__type, uObject_typeof()->Array(), NULL), (void*)NavigationControl__seekToPath_fn)), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New2(::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(__type, NULL), uString::Const("modifyPath"), uDelegate::New(::g::Uno::Action2_typeof()->MakeType(__type, uObject_typeof()->Array(), NULL), (void*)NavigationControl__modifyPath_fn))));
}
...
// private object Fuse.Node.ISubtreeDataProvider.GetData(Fuse.Node n) :179
...
void NavigationControl__OnRooted_fn(NavigationControl* __this)
{
    ...
    for (::g::Fuse::Elements::Element* c = (::g::Fuse::Elements::Element*)__this->FirstChild(::TYPES[40/*Fuse.Visual.FirstChild<Fuse.Elements.Element>*/]); c != NULL; c = (::g::Fuse::Elements::Element*)uPtr(c)->NextSibling(::TYPES[41/*Fuse.Node.NextSibling<Fuse.Elements.Element>*/]))
...
void NavigationControl::DisableBlockInput()
{
    ...
    {
        ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(Children()), ::TYPES[5/*Uno.Collections.ICollection<Fuse.Node>*/]), _blockInputTrigger, &ret6);
...
void NavigationControl::EnableBlockInput()
{
    if (_blockInputTrigger == NULL)
    {
        ...
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Children()), ::TYPES[5/*Uno.Collections.ICollection<Fuse.Node>*/]), _blockInputTrigger);
    }
}
...
void NavigationControl::FullUpdatePages(int32_t flags)
{
    ...
    if (pageNdx >= uPtr(uPtr(AncestorRouterPage())->ChildRouterPages())->Count())
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Inconsistent navigation history"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/NavigationControl.Pages.uno"), 101, uString::Const("FullUpdatePages"));
    }
    else if (pageNdx >= 0)
    ...
    if (navRequest != NULL)
    {
        if (!uPtr(rr)->AddArguments(navRequest, 152))
            ::g::Fuse::Diagnostics::UserError(uString::Const("Invalid $navigationRequest, visual result may not match expectation"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/NavigationControl.Pages.uno"), 121, uString::Const("FullUpdatePages"), NULL);
    }
...
{
    return (((::g::Uno::String::op_Equality(a, NULL) || ::g::Uno::String::op_Equality(a, ::STRINGS[11/*""*/])) || ::g::Uno::String::op_Equality(a, uString::Const("\"\""))) || ::g::Uno::String::op_Equality(a, uString::Const("{}"))) || ::g::Uno::String::op_Equality(a, uString::Const("null"));
}
...
void NavigationControl::OnPageHistoryChanged()
{
    ...
    if (obs != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(uString::Const("PageHistory expects an observable array. It will not work correctly otherwise"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/NavigationControl.Pages.uno"), 54, uString::Const("OnPageHistoryChanged"), NULL);
...
void NavigationControl::alterPath(NavigationControl* nav, uArray* args, uString* opName, int32_t gotoMode)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(uString::Const("NavigationControl."), opName), ::STRINGS[54/*" requires 1...*/]), nav, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/NavigationControl.ScriptClass.uno"), 52, uString::Const("alterPath"), NULL);
        return;
    }
    ...
    if (outlet == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Must be an IRouterOutlet"), nav, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/NavigationControl.ScriptClass.uno"), 59, uString::Const("alterPath"));
        return;
    }

    uString* path = (::g::Fuse::Marshal__ToType_fn(::g::Fuse::Marshal_typeof()->MakeMethod(0/*ToType<string>*/, ::TYPES[66/*string*/], NULL), uPtr(args)->Strong<uObject*>(0), &ret1), ret1);
    uString* param = NULL;
    ...
    ::g::Fuse::Visual* ignore;
    ::g::Fuse::Navigation::IRouterOutlet::Goto(uInterface(uPtr(outlet), ::g::Fuse::Navigation::IRouterOutlet_typeof()), rPage, gotoMode, 0, ::STRINGS[11/*""*/], &ignore);
}
...
void NavigationControl::modifyPath(NavigationControl* nav, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("`modifyPath` takes on argument"), nav, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/NavigationControl.ScriptClass.uno"), 106, uString::Const("modifyPath"), NULL);
        return;
    }
    ...
    if (obj == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("`modifyPath` should be passed an object"), nav, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/NavigationControl.ScriptClass.uno"), 113, uString::Const("modifyPath"), NULL);
        return;
    }
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("`modifyPath` unrecognized arguments"), nav, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/NavigationControl.ScriptClass.uno"), 122, uString::Const("modifyPath"), NULL);
        return;
    }

    if ((rr->Route != NULL) && (uPtr(rr->Route)->SubRoute != NULL))
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("`modifyPath` expects one route component"), nav, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/NavigationControl.ScriptClass.uno"), 128, uString::Const("modifyPath"), NULL);
        return;
    }
    ...
    if (page == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("`modifyPath` unable to find route component"), nav, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/NavigationControl.ScriptClass.uno"), 140, uString::Const("modifyPath"), NULL);
        return;
    }
    ...
    switch (rr->How)
    {
        ...
        default:
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition1(uString::Const("Unsupported `How`: "), uBox<int32_t>(::g::Fuse::Navigation::ModifyRouteHow_typeof(), uPtr(rr)->How)), nav, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/NavigationControl.ScriptClass.uno"), 188, uString::Const("modifyPath"), NULL);
            return;
        }
    }
...
// /usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/Navigator.Types.uno
// --------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/Navigator.Interaction.uno
// --------------------------------------------------------------------------------------
...
void Navigator__CreateTriggers_fn(Navigator* __this, ::g::Fuse::Elements::Element* c, ::g::Fuse::Controls::NavigationControl__ControlPageData* pd)
{
    switch (__this->PageTransition(c))
    {
        ...
        case 2:
        {
            ...
            ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(q->Animators()), ::TYPES[31/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), fade);
            pd->Removing = q;
            break;
        }
    }
...
void Navigator__FuseNavigationIRouterOutletCancelPrepare_fn(Navigator* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("PartialPrepareGoto without Prepare"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/Navigator.uno"), 168, uString::Const("Fuse.Navigation.IRouterOutlet.CancelPrepare"));
        return;
    }
...
void Navigator__FuseNavigationIRouterOutletPartialPrepareGoto_fn(Navigator* __this, double* progress)
{
    ...
    if (__this->_prepared == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("PartialPrepareGoto without Prepare"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/Navigator.uno"), 147, uString::Const("Fuse.Navigation.IRouterOutlet.PartialPrepareGoto"));
        return;
    }
...
void Navigator__OnChildRemoved_fn(Navigator* __this, ::g::Fuse::Node* elm)
{
    if (elm == uPtr(__this->_current)->Visual)
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Removing child!"), NULL, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/Navigator.uno"), 795, uString::Const("OnChildRemoved"));

    if ((__this->_deferred != NULL) && (uPtr(uPtr(__this->_deferred)->Page)->Visual == elm))
        ::g::Fuse::Diagnostics::InternalError(uString::Const("removing deferred child"), NULL, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/Navigator.uno"), 797, uString::Const("OnChildRemoved"));

    if ((__this->_prepared != NULL) && (uPtr(__this->_prepared)->Visual == elm))
        ::g::Fuse::Diagnostics::InternalError(uString::Const("removing prepared child"), NULL, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/Navigator.uno"), 799, uString::Const("OnChildRemoved"));
...
void Navigator__OnRooted_fn(Navigator* __this)
{
    ...
    if ((pages != NULL) && (uPtr(pages)->Count() > 0))
        ::g::Fuse::Navigation::IRouterOutlet::Goto(uInterface((uObject*)__this, ::g::Fuse::Navigation::IRouterOutlet_typeof()), (::g::Fuse::Navigation::RouterPage*)uPtr(pages)->Item(uPtr(pages)->Count() - 1), 1, 0, ::STRINGS[11/*""*/], &ignore);
    else
    {
        if (::g::Uno::String::op_Inequality(__this->DefaultPath(), NULL))
        {
            ...
            ::g::Fuse::Navigation::IRouterOutlet::Goto(uInterface((uObject*)__this, ::g::Fuse::Navigation::IRouterOutlet_typeof()), uPtr(__this->_current)->RouterPage, 1, 0, ::STRINGS[11/*""*/], &uPtr(__this->_current)->Visual);
        }
...
{
    ::g::Fuse::UpdateManager::AddDeferredAction3(uDelegate::New(::TYPES[34/*Uno.Action*/], (void*)Navigator__SwitchDeferred_fn, this), 4);
}
...
void Navigator::CleanupListenBusy()
{
    ...
    if (_listenBusy != NULL)
    {
        ::g::Fuse::Triggers::BusyTask::RemoveListener(_listenBusy, uDelegate::New(::TYPES[34/*Uno.Action*/], (void*)Navigator__BusyChanged_fn, this));
        ::g::Fuse::UpdateManager::RemoveAction1(uDelegate::New(::TYPES[34/*Uno.Action*/], (void*)Navigator__OnUpdate_fn, this), 0);
        _listenBusy = NULL;
    }
}
...
::g::Fuse::Visual* Navigator::GetVisual(uString* path)
{
    ...
    ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(uString::Const("Can not navigate to '"), path), uString::Const("', not found!")), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/Navigator.uno"), 430, uString::Const("GetVisual"));
    return NULL;
}
...
int32_t Navigator::GotoImpl(::g::Fuse::Navigation::RouterPage* routerPage, int32_t gotoMode, int32_t operation, uString* operationStyle, ::g::Fuse::Visual** pageVisual)
{
    ...
    *pageVisual = NULL;
    ...
    if (result.Page == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Unexpected null page"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/Navigator.uno"), 402, uString::Const("GotoImpl"));
        return 3;
    }
...
::g::Fuse::Visual* Navigator::InstantiateTemplate(::g::Uno::UX::Template* f, uString* path)
{
    ...
    if (useVisual == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(uString::Const("Result of '"), path), uString::Const("' template is not a Visual!")), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/Navigator.uno"), 439, uString::Const("InstantiateTemplate"), NULL);
        return NULL;
    }
...
Navigator__PrepareResult Navigator::Prepare1(Navigator__NavPage* curPage, ::g::Fuse::Navigation::RouterPage* routerPage, int32_t operation)
{
    ...
    if (::g::Uno::String::op_Equality(uPtr(routerPage)->Path(), uPtr(curPage->RouterPage)->Path()) && (curPageVisual != NULL))
    {
        ...
        bool compat = CompatibleParameter(uPtr(routerPage)->Parameter, uPtr(uPtr(curPage)->RouterPage)->Parameter);
    ...
    if (useVisual != NULL)
    {
        ...
        if (!(::g::Uno::Collections::ICollection::Contains_ex(uInterface(uPtr(Children()), ::TYPES[5/*Uno.Collections.ICollection<Fuse.Node>*/]), useVisual, &ret16), ret16))
...
void Navigator::RootInteraction()
{
    ...
    if (SwipeBack() == 0)
    {
        if (_navigatorSwipeBack != NULL)
        {
            ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(Children()), ::TYPES[5/*Uno.Collections.ICollection<Fuse.Node>*/]), _navigatorSwipeBack, &ret17);
    ...
    if (_router == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Navigator requires a Router for interaction"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/Navigator.Interaction.uno"), 67, uString::Const("RootInteraction"), NULL);
        return;
    }

    uPtr(_router)->add_HistoryChanged(uDelegate::New(::TYPES[68/*Fuse.Navigation.HistoryChangedHandler*/], (void*)Navigator__OnHistoryChanged_fn, this));
    ...
    if ((deferredVisual != NULL) && !_listenTimeout)
    {
        ...
        if ((busy & DeferPageSwitch()) != 0)
        {
            if (_listenBusy == NULL)
            {
                ...
                _listenTimeout = false;
                ::g::Fuse::Triggers::BusyTask::AddListener(_listenBusy, uDelegate::New(::TYPES[34/*Uno.Action*/], (void*)Navigator__BusyChanged_fn, this));
                ::g::Fuse::UpdateManager::AddAction1(uDelegate::New(::TYPES[34/*Uno.Action*/], (void*)Navigator__OnUpdate_fn, this), 0);
            }
...
// /usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/NavigatorSwipe.uno
// -------------------------------------------------------------------------------
...
{
    ::STRINGS[25] = uString::Const("SwipeNavigator requires a Router for interaction");
    ::STRINGS[26] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/NavigatorSwipe.uno");
    ::STRINGS[27] = uString::Const("OnRooted");
    ::STRINGS[28] = uString::Const("SwipeNavigator requires an Element parent");
    ::TYPES[29] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Triggers::Actions::TriggerAction_typeof(), NULL);
    ::TYPES[5] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[3] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[30] = ::g::Fuse::Animations::Change_typeof()->MakeType(::g::Uno::Double_typeof(), NULL);
...
void NavigatorSwipe__OnRooted_fn(NavigatorSwipe* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[25/*"SwipeNaviga...*/], __this, ::STRINGS[26/*"/usr/local/...*/], 191, ::STRINGS[27/*"OnRooted"*/], NULL);
        return;
    }

    if (!uIs((::g::Fuse::Visual*)__this->Parent(), ::TYPES[3/*Fuse.Elements.Element*/]))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[28/*"SwipeNaviga...*/], __this, ::STRINGS[26/*"/usr/local/...*/], 196, ::STRINGS[27/*"OnRooted"*/], NULL);
        return;
    }
    ...
    __this->_prepareAnim = (collection3 = (::g::Fuse::Animations::Change*)::g::Fuse::Animations::Change::New2(::TYPES[30/*Fuse.Animations.Change<double>*/], ::g::Fuse::Controls::Router_PrepareProgress_Property::New1(__this->_router)), ::g::Fuse::Animations::Change__set_Value_fn(uPtr(collection3), uCRef(1.0)), 1.0, collection3);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(__this->_swipeAnim)->Animators()), ::TYPES[31/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), __this->_prepareAnim);
}
...
{
    bool ret5;
    ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(uPtr(__this->_swipeAnim)->Animators()), ::TYPES[31/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), __this->_prepareAnim, &ret5);
...
void NavigatorSwipe::ctor_4()
{
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(_swipeAnim)->Actions()), ::TYPES[29/*Uno.Collections.ICollection<Fuse.Triggers.Actions.TriggerAction>*/]), _modify);
    _swipedCompleted = ::g::Fuse::Gestures::Swiped::New2(_swipeGesture);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(_swipedCompleted)->Actions()), ::TYPES[29/*Uno.Collections.ICollection<Fuse.Triggers.Actions.TriggerAction>*/]), (collection2 = ::g::Fuse::Navigation::RouterModify::New3(0), uPtr(collection2)->How(7), 7, collection2));
    _swipedCancelled = ::g::Fuse::Gestures::Swiped::New2(_swipeGesture);
    uPtr(_swipedCancelled)->How(3);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(_swipedCancelled)->Actions()), ::TYPES[29/*Uno.Collections.ICollection<Fuse.Triggers.Actions.TriggerAction>*/]), ::g::Fuse::Navigation::RouterCancelNavigation::New2());
...
// private bool get_CollapseInactive() :303
void PageControl__get_CollapseInactive_fn(PageControl* __this, bool* __retval)
{
    *__retval = __this->CollapseInactive();
}

// protected override sealed void CreateTriggers(Fuse.Elements.Element c, Fuse.Controls.NavigationControl.ControlPageData pd) :279
...
// private bool get_DisableInactive() :308
...
// private Fuse.Navigation.RouterPage Fuse.Navigation.IRouterOutlet.GetCurrent(Fuse.Visual& pageVisual) :249
void PageControl__FuseNavigationIRouterOutletGetCurrent_fn(PageControl* __this, ::g::Fuse::Visual** pageVisual, ::g::Fuse::Navigation::RouterPage** __retval)
{
    *pageVisual = __this->Active();
    ...
    if (__this->Active() == NULL)
        return *__retval = ::g::Fuse::Navigation::RouterPage::New1(::STRINGS[11/*""*/], NULL, NULL), void();
    else
        return *__retval = uPtr(::g::Fuse::Navigation::PageData::Get(__this->Active()))->RouterPage(), void();
}

// private Fuse.Navigation.RoutingResult Fuse.Navigation.IRouterOutlet.Goto(Fuse.Navigation.RouterPage routerPage, Fuse.Navigation.NavigationGotoMode gotoMode, Fuse.Navigation.RoutingOperation operation, string operationStyle, Fuse.Visual& pageVisual) :206
...
// private void Fuse.Navigation.ISeekableNavigation.BeginSeek() :421
...
// private void Fuse.Navigation.ISeekableNavigation.EndSeek(Fuse.Navigation.EndSeekArgs args) :424
...
// private void Fuse.Navigation.ISeekableNavigation.Seek(Fuse.Navigation.UpdateSeekArgs args) :423
...
// private bool get_IsHorizontal() :399
...
// private void OnActivePageChanged(object sender, Fuse.Visual active) :225
...
// protected override sealed void UpdateInteraction() :313
void PageControl__UpdateInteraction_fn(PageControl* __this)
{
    ...
    {
        if (__this->_swipe != NULL)
            ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(__this->Children()), ::TYPES[5/*Uno.Collections.ICollection<Fuse.Node>*/]), __this->_swipe, &ret2);
...
// protected override sealed void UpdateProgress(Fuse.Elements.Element page, Fuse.Navigation.NavigationPageState state, Fuse.Controls.NavigationControl.ControlPageData pd) :268
...
// private bool get_CollapseInactive() [instance] :303
bool PageControl::CollapseInactive()
{
    return _inactive == 0;
}

// private bool get_DisableInactive() [instance] :308
...
::g::Fuse::Visual* PageControl::FindPath(uString* path)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(uString::Const("Can not navigate to '"), path), uString::Const("', not found!")), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/PageControl.uno"), 181, uString::Const("FindPath"));
        return NULL;
    }
...
// private bool get_IsHorizontal() [instance] :399
...
// private void OnActivePageChanged(object sender, Fuse.Visual active) [instance] :225
...
void PageControl::UpdatePages()
{
    ...
    for (int32_t i = 0; i < uPtr(_pagesMap)->Count(); ++i)
    {
        ...
        {
            ::g::Fuse::Diagnostics::UserError(uString::Const("null page in list"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/PageControl.Pages.uno"), 109, uString::Const("UpdatePages"), NULL);
            continue;
        }
        ...
        {
            ::g::Fuse::Diagnostics::UserError(uString::Const("Model is missing a $template or $page property"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/PageControl.Pages.uno"), 116, uString::Const("UpdatePages"), NULL);
            continue;
        }
        ...
        if (f == NULL)
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(uString::Const("No matching template path: "), uPtr(mp)->Template), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/PageControl.Pages.uno"), 123, uString::Const("UpdatePages"), NULL);
            continue;
        }
        ...
        if (mp->Visual == NULL)
        {
            ...
            if (mp->Visual == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(uString::Const("Template is not a Visual: "), uPtr(mp)->Template), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/PageControl.Pages.uno"), 132, uString::Const("UpdatePages"), NULL);
                continue;
            }
        }
...
void PageControl::gotoPage(PageControl* pc, uArray* args)
{
    ...
    if (target != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(uString::Const("PageControl.goto() : Argument must be a node object"), pc, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/PageControl.uno"), 98, uString::Const("gotoPage"), NULL);
}
// }

// /usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/.uno/ux13/Fuse.Controls.PageIndicatorDot.g.uno
// -----------------------------------------------------------------------------------------------------------
...
static void PageIndicatorDot_build(uType* type)
{
    ...
    ::TYPES[32] = ::g::Fuse::Animations::Change_typeof()->MakeType(::g::Uno::Float4_typeof(), NULL);
    ::TYPES[31] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Animations::Animator_typeof(), NULL);
    ::TYPES[5] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Controls::Panel_type, interface0),
...
void PageIndicatorDot::InitializeUX()
{
    ...
    ::g::Fuse::Animations::Change* temp2 = (::g::Fuse::Animations::Change*)::g::Fuse::Animations::Change::New2(::TYPES[32/*Fuse.Animations.Change<float4>*/], TheCircle_Color_inst);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp->Animators()), ::TYPES[31/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp1);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp->Animators()), ::TYPES[31/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp2);
    temp1->Factor(1.2f);
...
// /usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/PageIndicator.uno
// ------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Panels/1.6.0/Panel.Freeze.uno
// -------------------------------------------------------------------------
...
static void Panel_build(uType* type)
{
    ::STRINGS[29] = uString::Const("Color");
    ::STRINGS[11] = uString::Const("");
    ::STRINGS[31] = uString::Const("unable to freeze non-flat or infinite element");
    ::STRINGS[32] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Panels/1.6.0/Panel.Freeze.uno");
    ::STRINGS[33] = uString::Const("OnPrepared");
    ::STRINGS[34] = uString::Const("unable to freeze element");
    ::STRINGS[35] = uString::Const("Panel.IsFrozen cannot be used when a Panel is in a Surface");
    ::STRINGS[36] = uString::Const("SetupListener");
    ::TYPES[33] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::DrawContext_typeof(), NULL);
...
void Panel__Draw_fn(Panel* __this, ::g::Fuse::DrawContext* dc)
{
    ...
    uPtr(::g::Fuse::Drawing::Blitter::Singleton())->Blit1(uPtr(__this->_frozenBuffer)->ColorBuffer(), rect, uPtr(dc)->GetLocalToClipTransform(__this), __this->Opacity(), true, 0);
}
...
void Panel::CleanupListener(bool nextFrame)
{
    ...
    {
        ::g::Fuse::Internal::DrawManager::remove_Prepared(uDelegate::New(::TYPES[33/*Uno.Action<Fuse.DrawContext>*/], (void*)Panel__OnPrepared_fn, this));

        if (nextFrame)
            ::g::Fuse::UpdateManager::PerformNextFrame(uDelegate::New(::TYPES[34/*Uno.Action*/], (void*)Panel__EndBusy_fn, this), 0, 1);
        else
            EndBusy();
...
void Panel::EndBusy()
{
    ::g::Fuse::Triggers::BusyTask::SetBusy(this, &_freezeBusyTask, 0, ::STRINGS[11/*""*/]);
}
...
void Panel::OnPrepared(::g::Fuse::DrawContext* dc)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[31/*"unable to f...*/], this, ::STRINGS[32/*"/usr/local/...*/], 140, ::STRINGS[33/*"OnPrepared"*/]);
        return;
    }
    ...
    if (_frozenBuffer == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[34/*"unable to f...*/], this, ::STRINGS[32/*"/usr/local/...*/], 147, ::STRINGS[33/*"OnPrepared"*/]);
        return;
    }
...
void Panel::SetupListener()
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[35/*"Panel.IsFro...*/], this, ::STRINGS[32/*"/usr/local/...*/], 88, ::STRINGS[36/*"SetupListener"*/], NULL);
        return;
    }

    if (!_freezeAwaitPrepared)
    {
        ::g::Fuse::Internal::DrawManager::add_Prepared(uDelegate::New(::TYPES[33/*Uno.Action<Fuse.DrawContext>*/], (void*)Panel__OnPrepared_fn, this));
        ::g::Fuse::Triggers::BusyTask::SetBusy(this, &_freezeBusyTask, 8, ::STRINGS[11/*""*/]);
        _freezeAwaitPrepared = true;
    }
}
// }

// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.6.0/Shapes/Path.Surface.uno
// ------------------------------------------------------------------------------------
...
void Path__CreateSurfacePath_fn(Path* __this, ::g::Fuse::Drawing::Surface* surface, ::g::Fuse::Drawing::SurfacePath** __retval)
{
    ...
    Path__Positioning pos = __this->CalcPositioning();
    ::g::Uno::Collections::List* list = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[35/*Uno.Collections.List<Fuse.Drawing.LineSegment>*/]);

    for (int32_t i = 0; i < uPtr(__this->_segments)->Count(); ++i)
    {
        ::g::Fuse::Drawing::LineSegment seg = (::g::Uno::Collections::List__get_Item_fn(uPtr(__this->_segments), uCRef<int32_t>(i), &ret8), ret8);
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.6.0/Shapes/Rectangle.Surface.uno
// -----------------------------------------------------------------------------------------
...
{
    Rectangle::CornerRadiusPropertyName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[37/*"CornerRadius"*/]);
}

static void Rectangle_build(uType* type)
{
    ::STRINGS[37] = uString::Const("CornerRadius");
    ::TYPES[35] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Drawing::LineSegment_typeof(), NULL);
    ::TYPES[36] = ::g::Fuse::Controls::Native::IRectangleView_typeof();
    type->SetDependencies(
...
void Rectangle__CreateSurfacePath_fn(Rectangle* __this, ::g::Fuse::Drawing::Surface* surface, ::g::Fuse::Drawing::SurfacePath** __retval)
{
    ...
    collection1 = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[35/*Uno.Collections.List<Fuse.Drawing.LineSegment>*/]);
...
void Rectangle__PushPropertiesToNativeView_fn(Rectangle* __this)
{
    ...
    if (nr != NULL)
        ::g::Fuse::Controls::Native::IRectangleView::CornerRadius(uInterface(uPtr(nr), ::TYPES[36/*Fuse.Controls.Native.IRectangleView*/]), __this->CornerRadius());
}
...
{
    return uAs<uObject*>(NativeView(), ::TYPES[36/*Fuse.Controls.Native.IRectangleView*/]);
}
...
void Rectangle::SetCornerRadius(::g::Uno::Float4 value, uObject* origin)
{
    if (::g::Uno::Float4__op_Inequality(_cornerRadius, value))
    {
        ...
        if (nr != NULL)
            ::g::Fuse::Controls::Native::IRectangleView::CornerRadius(uInterface(uPtr(nr), ::TYPES[36/*Fuse.Controls.Native.IRectangleView*/]), CornerRadius());
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.6.0/Shapes/RegularPolygon.Surface.uno
// ----------------------------------------------------------------------------------------------
...
{
    ::STRINGS[38] = uString::Const("Sides");
    ::TYPES[35] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Drawing::LineSegment_typeof(), NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Controls::Shape_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Controls::Shape_type, interface1),
...
void RegularPolygon::Sides(int32_t value)
{
    ...
    _sides = value;
    InvalidateSurfacePath();
    OnPropertyChanged(::g::Uno::UX::Selector__op_Implicit(::STRINGS[38/*"Sides"*/]));
}
// }
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.6.0/Shapes/Shape.Resources.uno
// ---------------------------------------------------------------------------------------
...
{
    ::STRINGS[39] = uString::Const("PrepareProgress");
    ::TYPES[37] = ::g::Fuse::Navigation::Router_typeof();
    type->SetBase(::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Double_typeof(), NULL));
    type->SetFields(1,
        ::TYPES[37/*Fuse.Navigation.Router*/], offsetof(Router_PrepareProgress_Property, _obj), 0);
}
...
{
    return *__retval = uPtr(uCast< ::g::Fuse::Navigation::Router*>(obj, ::TYPES[37/*Fuse.Navigation.Router*/]))->PrepareProgress(), void();
}
...
{
    double v_ = *v;
    uPtr(uCast< ::g::Fuse::Navigation::Router*>(obj, ::TYPES[37/*Fuse.Navigation.Router*/]))->PrepareProgress(v_);
}
...
{
    ctor_2(::g::Uno::UX::Selector__op_Implicit(::STRINGS[39/*"PrepareProg...*/]));
    _obj = obj;
}
...
// /usr/local/share/uno/Packages/Fuse.Controls.Native/1.6.0/Enums.uno
// ------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.6.0/ScrollView.uno
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.6.0/ScrollView.ux.uno
// ------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.6.0/ScrollView.Layout.uno
// ----------------------------------------------------------------------------------
...
{
    ::g::Fuse::Scripting::ScriptClass_typeof()->Init();
    ScrollViewBase::SizingChanged_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[40/*"SizingChanged"*/]);
    ScrollViewBase::UserScrollName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[41/*"UserScroll"*/]);
    ScrollViewBase::GesturePriorityName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[42/*"GesturePrio...*/]);
    ScrollViewBase::_keepFocusInViewName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[43/*"KeepFocusIn...*/]);
    ScrollViewBase::_allowedScrollDirectionsName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[44/*"AllowedScro...*/]);
    ScrollViewBase::ScrollPositionName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[45/*"ScrollPosit...*/]);
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[19/*Fuse.Scripting.ScriptMember[]*/], 4, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New2(::TYPES[38/*Fuse.Scripting.ScriptMethod<Fuse.Controls.ScrollViewBase>*/], ::STRINGS[46/*"goto"*/], uDelegate::New(::TYPES[39/*Uno.Action<Fuse.Controls.ScrollViewBase, object[]>*/], (void*)ScrollViewBase__goto__fn)), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New2(::TYPES[38/*Fuse.Scripting.ScriptMethod<Fuse.Controls.ScrollViewBase>*/], ::STRINGS[47/*"gotoRelative"*/], uDelegate::New(::TYPES[39/*Uno.Action<Fuse.Controls.ScrollViewBase, object[]>*/], (void*)ScrollViewBase__gotoRelative_fn)), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New2(::TYPES[38/*Fuse.Scripting.ScriptMethod<Fuse.Controls.ScrollViewBase>*/], ::STRINGS[48/*"seekTo"*/], uDelegate::New(::TYPES[39/*Uno.Action<Fuse.Controls.ScrollViewBase, object[]>*/], (void*)ScrollViewBase__seekTo_fn)), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New2(::TYPES[38/*Fuse.Scripting.ScriptMethod<Fuse.Controls.ScrollViewBase>*/], ::STRINGS[49/*"seekToRelat...*/], uDelegate::New(::TYPES[39/*Uno.Action<Fuse.Controls.ScrollViewBase, object[]>*/], (void*)ScrollViewBase__seekToRelative_fn))));
}

static void ScrollViewBase_build(uType* type)
{
    ::STRINGS[40] = uString::Const("SizingChanged");
    ::STRINGS[41] = uString::Const("UserScroll");
    ::STRINGS[42] = uString::Const("GesturePriority");
    ::STRINGS[43] = uString::Const("KeepFocusInView");
    ::STRINGS[44] = uString::Const("AllowedScrollDirections");
    ::STRINGS[45] = uString::Const("ScrollPosition");
    ::STRINGS[46] = uString::Const("goto");
    ::STRINGS[47] = uString::Const("gotoRelative");
    ::STRINGS[48] = uString::Const("seekTo");
    ::STRINGS[49] = uString::Const("seekToRelative");
    ::STRINGS[50] = uString::Const("AllowedScrollDirections is not valid: ");
    ::STRINGS[51] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.6.0/ScrollView.Layout.uno");
    ::STRINGS[52] = uString::Const("ArrangeContent");
    ::STRINGS[53] = uString::Const("ScrollViewBase.");
    ::STRINGS[54] = uString::Const(" requires 1 or 2 arguments");
    ::STRINGS[55] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.6.0/ScrollView.ScriptClass.uno");
    ...
    ::STRINGS[60] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.6.0/ScrollView.uno");
    ::STRINGS[61] = uString::Const("set_Motion");
    ::TYPES[18] = ::g::Uno::Type_typeof();
    ::TYPES[19] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[38] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(type, NULL);
    ::TYPES[39] = ::g::Uno::Action2_typeof()->MakeType(type, uObject_typeof()->Array(), NULL);
    ::TYPES[3] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[34] = ::g::Uno::Action_typeof();
    ::TYPES[40] = ::g::Fuse::Visual_typeof()->MakeMethod(2/*FirstChild<Fuse.Elements.Element>*/, ::TYPES[3/*Fuse.Elements.Element*/], NULL);
    ::TYPES[41] = ::g::Fuse::Node_typeof()->MakeMethod(3/*NextSibling<Fuse.Elements.Element>*/, ::TYPES[3/*Fuse.Elements.Element*/], NULL);
    ::TYPES[5] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[42] = ::g::Fuse::Controls::Native::IScrollView_typeof();
    ::TYPES[43] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1/*FirstOrDefault<Fuse.Node>*/, ::g::Fuse::Node_typeof(), NULL);
    ::TYPES[44] = ::g::Fuse::Controls::ScrollPositionChangedHandler_typeof();
    type->SetDependencies(
    ...
    type->SetFields(103,
        ...
        ::TYPES[44/*Fuse.Controls.ScrollPositionChangedHandler*/], offsetof(ScrollViewBase, ScrollPositionChanged1), 0,
...
void ScrollViewBase__ArrangePaddingBox_fn(ScrollViewBase* __this, ::g::Fuse::LayoutParams* lp)
{
    ...
    ::g::Fuse::UpdateManager::AddDeferredAction3(uDelegate::New(::TYPES[34/*Uno.Action*/], (void*)ScrollViewBase__UpdateScrollPosition_fn, __this), 4);
}
...
{
    ::g::Fuse::Node* ret13;
    ::g::Fuse::Elements::Element* content = uAs< ::g::Fuse::Elements::Element*>((::g::Uno::Collections::EnumerableExtensions__FirstOrDefault_fn(::TYPES[43/*Uno.Collections.EnumerableExtensions.FirstOrDefault<Fuse.Node>*/], __this->Children(), &ret13), ret13), ::TYPES[3/*Fuse.Elements.Element*/]);
...
void ScrollViewBase::AllowedScrollDirections(int32_t value)
{
    if (_allowedScrollDirections != value)
    {
        ...
        if (s != NULL)
            ::g::Fuse::Controls::Native::IScrollView::AllowedScrollDirections(uInterface(uPtr(s), ::TYPES[42/*Fuse.Controls.Native.IScrollView*/]), _allowedScrollDirections);
    }
}
...
void ScrollViewBase::ArrangeContent(::g::Fuse::LayoutParams lp)
{
    ...
    else if (AllowedScrollDirections() == 12)
    {
        ...
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition1(::STRINGS[50/*"AllowedScro...*/], uBox<int32_t>(::g::Fuse::Controls::ScrollDirections_typeof(), AllowedScrollDirections())), this, ::STRINGS[51/*"/usr/local/...*/], 171, ::STRINGS[52/*"ArrangeCont...*/], NULL);
...
::g::Fuse::Elements::Element* ScrollViewBase::FindAnchorElement()
{
    ...
    for (::g::Fuse::Elements::Element* c = (::g::Fuse::Elements::Element*)uPtr(Element())->FirstChild(::TYPES[40/*Fuse.Visual.FirstChild<Fuse.Elements.Element>*/]); c != NULL; c = (::g::Fuse::Elements::Element*)uPtr(c)->NextSibling(::TYPES[41/*Fuse.Node.NextSibling<Fuse.Elements.Element>*/]))
    {
...
void ScrollViewBase::Motion(::g::Fuse::Motion::MotionConfig* value)
{
    ...
    if (IsRootingCompleted())
        ::g::Fuse::Diagnostics::UserError(::STRINGS[59/*"Motion shou...*/], this, ::STRINGS[60/*"/usr/local/...*/], 210, ::STRINGS[61/*"set_Motion"*/], NULL);
}

// private Fuse.Controls.Native.IScrollView get_NativeScrollView() [instance] :12
uObject* ScrollViewBase::NativeScrollView()
{
    return uAs<uObject*>(NativeView(), ::TYPES[42/*Fuse.Controls.Native.IScrollView*/]);
}
...
{
    ScrollPositionChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(ScrollPositionChanged1, value), ::TYPES[44/*Fuse.Controls.ScrollPositionChangedHandler*/]);
}
...
{
    ScrollPositionChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(ScrollPositionChanged1, value), ::TYPES[44/*Fuse.Controls.ScrollPositionChangedHandler*/]);
}
...
void ScrollViewBase::SetScrollPositionImpl(::g::Uno::Float2 position, ::g::Uno::Float2 arrangeOffset, bool adjustment, uObject* origin)
{
    ...
    if (origin != NULL)
    {
        ...
        if (sv != NULL)
            ::g::Fuse::Controls::Native::IScrollView::ScrollPosition(uInterface(uPtr(sv), ::TYPES[42/*Fuse.Controls.Native.IScrollView*/]), position);
    }
...
void ScrollViewBase::UpdateScrollPosition()
{
    ...
    if ((_scroller != NULL) && IsRootingCompleted())
        ::g::Fuse::UpdateManager::AddDeferredAction3(uDelegate::New(::TYPES[34/*Uno.Action*/], (void*)::g::Fuse::Gestures::Scroller__CheckLimits_fn, uPtr(_scroller)), 4);
    else
    {
        ScrollPosition(::g::Uno::Math::Min3(MaxScroll(), ::g::Uno::Math::Max3(MinScroll(), ScrollPosition())));
...
bool ScrollViewBase::getParams(ScrollViewBase* s, uArray* args, uString* func, ::g::Uno::Float2* pos)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[53/*"ScrollViewB...*/], func), ::STRINGS[54/*" requires 1...*/]), s, ::STRINGS[55/*"/usr/local/...*/], 23, ::STRINGS[56/*"getParams"*/], NULL);
...
void ScrollViewBase::goto_(ScrollViewBase* s, uArray* args)
{
    ...
    if (!ScrollViewBase::getParams(s, args, ::STRINGS[46/*"goto"*/], &pos))
        return;
...
void ScrollViewBase::seekTo(ScrollViewBase* s, uArray* args)
{
    ...
    if (!ScrollViewBase::getParams(s, args, ::STRINGS[48/*"seekTo"*/], &pos))
        return;
...
void ScrollViewBase::seekToRelative(ScrollViewBase* s, uArray* args)
{
    ...
    if (!ScrollViewBase::getParams(s, args, ::STRINGS[49/*"seekToRelat...*/], &pos))
        return;
...
// /usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.6.0/ScrollViewPager.ScriptClass.uno
// --------------------------------------------------------------------------------------------
...
{
    ::g::Fuse::Scripting::ScriptClass_typeof()->Init();
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[19/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New3(::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(__type, NULL), uString::Const("check"), uDelegate::New(::g::Uno::Action1_typeof()->MakeType(__type, NULL), (void*)ScrollViewPager__check_fn))));
}
...
void ScrollViewPager__OnRooted_fn(ScrollViewPager* __this)
{
    ...
    if (__this->Each() == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Require an Each"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.6.0/ScrollViewPager.uno"), 90, ::STRINGS[27/*"OnRooted"*/], NULL);
        return;
    }
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Could not find a Scrollable control."), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.6.0/ScrollViewPager.uno"), 100, ::STRINGS[27/*"OnRooted"*/], NULL);
        return;
    }

    if (uPtr(__this->_scrollable)->LayoutMode() == 0)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("The ScrollView should have `LayoutMode=\"PreserveVisual\"` for paging to work correctly"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.6.0/ScrollViewPager.uno"), 107, ::STRINGS[27/*"OnRooted"*/], NULL);
        return;
    }
...
void ScrollViewPager::Check()
{
    ...
    ::g::Fuse::UpdateManager::AddDeferredAction2(uDelegate::New(::TYPES[34/*Uno.Action*/], (void*)ScrollViewPager__CheckSizing_fn, this), -1, 2);
}
...
void ScrollViewPager::CheckSizing()
{
    ...
    _pendingSizing = true;
    ::g::Fuse::UpdateManager::PerformNextFrame(uDelegate::New(::TYPES[34/*Uno.Action*/], (void*)ScrollViewPager__CheckSizing_fn, this), 0, 1);
}
...
void ScrollViewPager::RequestCheckPosition()
{
    ...
    {
        ::g::Fuse::UpdateManager::AddDeferredAction2(uDelegate::New(::TYPES[34/*Uno.Action*/], (void*)ScrollViewPager__CheckPosition_fn, this), -1, 2);
...
// /usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.6.0/ScrollViewPager.uno
// --------------------------------------------------------------------------------
...
void Shape__CalcRenderBounds_fn(Shape* __this, ::g::Fuse::VisualBounds** __retval)
{
    ...
    {
        uObject* enum12 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(__this->Strokes()), ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::TYPES[27/*Fuse.Drawing.Stroke*/], NULL)));
            ...
            {
                {
                    ...
                    {
                        ::g::Fuse::Drawing::Stroke* stroke = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum12), ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::TYPES[27/*Fuse.Drawing.Stroke*/], NULL)), &ret17), ret17);
...
void Shape__DrawVisual_fn(Shape* __this, ::g::Fuse::DrawContext* dc)
{
    ...
    if (__this->HasFills())
    {
        uObject* enum10 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(__this->Fills()), ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::TYPES[28/*Fuse.Drawing.Brush*/], NULL)));
            ...
            {
                {
                    ...
                    {
                        ::g::Fuse::Drawing::Brush* fill = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum10), ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::TYPES[28/*Fuse.Drawing.Brush*/], NULL)), &ret19), ret19);
    ...
    if (__this->HasStrokes())
    {
        uObject* enum11 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(__this->Strokes()), ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::TYPES[27/*Fuse.Drawing.Stroke*/], NULL)));
            ...
            {
                {
                    ...
                    {
                        ::g::Fuse::Drawing::Stroke* stroke = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum11), ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::TYPES[27/*Fuse.Drawing.Stroke*/], NULL)), &ret20), ret20);
...
void Shape__FuseDrawingIDrawObjectWatcherFeedbackPrepare_fn(Shape* __this, uObject* obj)
{
    if (__this->_surface1 == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"Prepare wit...*/], __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.6.0/Shapes/Shape.Surface.uno"), 57, ::STRINGS[23/*"Fuse.Drawin...*/]);
        return;
    }
...
void Shape__FuseDrawingIDrawObjectWatcherFeedbackUnprepare_fn(Shape* __this, uObject* obj)
{
    if (__this->_surface1 == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"Prepare wit...*/], __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.6.0/Shapes/Shape.Surface.uno"), 70, ::STRINGS[24/*"Fuse.Drawin...*/]);
        return;
    }
...
void Shape__FuseDrawingISurfaceDrawableDraw_fn(Shape* __this, ::g::Fuse::Drawing::Surface* surface)
{
    ...
    if (__this->HasFills())
    {
        uObject* enum4 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(__this->Fills()), ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::TYPES[28/*Fuse.Drawing.Brush*/], NULL)));
            ...
            {
                {
                    ...
                    {
                        ::g::Fuse::Drawing::Brush* fill = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum4), ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::TYPES[28/*Fuse.Drawing.Brush*/], NULL)), &ret21), ret21);
    ...
    if (__this->HasStrokes())
    {
        uObject* enum5 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(__this->Strokes()), ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::TYPES[27/*Fuse.Drawing.Stroke*/], NULL)));
            ...
            {
                {
                    ...
                    {
                        ::g::Fuse::Drawing::Stroke* stroke = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum5), ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::TYPES[27/*Fuse.Drawing.Stroke*/], NULL)), &ret22), ret22);
    ...
    if (__this->HasFills())
    {
        uObject* enum6 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(__this->Fills()), ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::TYPES[28/*Fuse.Drawing.Brush*/], NULL)));
            ...
            {
                {
                    ...
                    {
                        ::g::Fuse::Drawing::Brush* fill1 = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum6), ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::TYPES[28/*Fuse.Drawing.Brush*/], NULL)), &ret23), ret23);
    ...
    if (__this->HasStrokes())
    {
        uObject* enum7 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(__this->Strokes()), ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::TYPES[27/*Fuse.Drawing.Stroke*/], NULL)));
            ...
            {
                {
                    ...
                    {
                        ::g::Fuse::Drawing::Stroke* stroke1 = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum7), ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::TYPES[27/*Fuse.Drawing.Stroke*/], NULL)), &ret24), ret24);
...
void Shape__OnPropertyChanged2_fn(Shape* __this, ::g::Uno::UX::PropertyObject* sender, ::g::Uno::UX::Selector* property)
{
    ...
    if (uIs(sender, ::TYPES[28/*Fuse.Drawing.Brush*/]))
        __this->InvalidateVisual();
    else if (uIs(sender, ::TYPES[27/*Fuse.Drawing.Stroke*/]))
    {
        __this->InvalidateVisual();
...
void Shape__OnRooted_fn(Shape* __this)
{
    ...
    if (__this->_strokes != NULL)
    {
        ...
        uPtr(__this->_strokes)->Subscribe(uDelegate::New(::g::Uno::Action1_typeof()->MakeType(::TYPES[27/*Fuse.Drawing.Stroke*/], NULL), (void*)Shape__OnStrokeAdded_fn, __this), uDelegate::New(::g::Uno::Action1_typeof()->MakeType(::TYPES[27/*Fuse.Drawing.Stroke*/], NULL), (void*)Shape__OnStrokeRemoved_fn, __this));
    }
    ...
    if (__this->_fills != NULL)
    {
        ...
        uPtr(__this->_fills)->Subscribe(uDelegate::New(::g::Uno::Action1_typeof()->MakeType(::TYPES[28/*Fuse.Drawing.Brush*/], NULL), (void*)Shape__OnFillAdded_fn, __this), uDelegate::New(::g::Uno::Action1_typeof()->MakeType(::TYPES[28/*Fuse.Drawing.Brush*/], NULL), (void*)Shape__OnFillRemoved_fn, __this));
    }
...
void Shape::CheckStatus()
{
    ...
    ::g::Fuse::Triggers::BusyTask::SetBusy(this, &_loadingResourceTask, loading ? 1 : 0, ::STRINGS[11/*""*/]);
}
...
{
    ::g::Uno::Collections::ICollection::Clear(uInterface(uPtr(Fills()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[28/*Fuse.Drawing.Brush*/], NULL)));

    if (value != NULL)
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Fills()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[28/*Fuse.Drawing.Brush*/], NULL)), value);
}
...
uObject* Shape::Fills()
{
    if (_fills == NULL)
    {
        _fills = ((::g::Uno::Collections::RootableList*)::g::Uno::Collections::RootableList::New1(::g::Uno::Collections::RootableList_typeof()->MakeType(::TYPES[28/*Fuse.Drawing.Brush*/], NULL)));

        if (IsRootingCompleted())
            uPtr(_fills)->Subscribe(uDelegate::New(::g::Uno::Action1_typeof()->MakeType(::TYPES[28/*Fuse.Drawing.Brush*/], NULL), (void*)Shape__OnFillAdded_fn, this), uDelegate::New(::g::Uno::Action1_typeof()->MakeType(::TYPES[28/*Fuse.Drawing.Brush*/], NULL), (void*)Shape__OnFillRemoved_fn, this));
    }
...
void Shape::OnFillAdded(::g::Fuse::Drawing::Brush* f)
{
    if (f == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Unexpected null brush"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.6.0/Shapes/Shape.uno"), 131, uString::Const("OnFillAdded"));
        return;
    }
...
void Shape::OnFillRemoved(::g::Fuse::Drawing::Brush* f)
{
    if (f == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Unexpected null brush"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.6.0/Shapes/Shape.uno"), 154, uString::Const("OnFillRemoved"));
        return;
    }
...
void Shape::OnStrokeAdded(::g::Fuse::Drawing::Stroke* s)
{
    if (s == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Unexpected null stroke"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.6.0/Shapes/Shape.uno"), 295, uString::Const("OnStrokeAdded"));
        return;
    }
...
void Shape::OnStrokeRemoved(::g::Fuse::Drawing::Stroke* s)
{
    if (s == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Unexpected null stroke"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.6.0/Shapes/Shape.uno"), 311, uString::Const("OnStrokeRemoved"));
        return;
    }
...
{
    ::g::Uno::Collections::ICollection::Clear(uInterface(uPtr(Strokes()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[27/*Fuse.Drawing.Stroke*/], NULL)));

    if (value != NULL)
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Strokes()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[27/*Fuse.Drawing.Stroke*/], NULL)), value);
}
...
uObject* Shape::Strokes()
{
    if (_strokes == NULL)
    {
        _strokes = ((::g::Uno::Collections::RootableList*)::g::Uno::Collections::RootableList::New1(::g::Uno::Collections::RootableList_typeof()->MakeType(::TYPES[27/*Fuse.Drawing.Stroke*/], NULL)));

        if (IsRootingCompleted())
            uPtr(_strokes)->Subscribe(uDelegate::New(::g::Uno::Action1_typeof()->MakeType(::TYPES[27/*Fuse.Drawing.Stroke*/], NULL), (void*)Shape__OnStrokeAdded_fn, this), uDelegate::New(::g::Uno::Action1_typeof()->MakeType(::TYPES[27/*Fuse.Drawing.Stroke*/], NULL), (void*)Shape__OnStrokeRemoved_fn, this));
    }
...
void Shape::UpdateNativeShape()
{
    ...
    if (ns != NULL)
    {
        uArray* fills = HasFills() ? (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(7/*ToArray<Fuse.Drawing.Brush>*/, ::TYPES[28/*Fuse.Drawing.Brush*/], NULL), Fills()) : uArray::New(::TYPES[28/*Fuse.Drawing.Brush*/]->Array(), 0);
        uArray* strokes = HasStrokes() ? (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(7/*ToArray<Fuse.Drawing.Stroke>*/, ::TYPES[27/*Fuse.Drawing.Stroke*/], NULL), Strokes()) : uArray::New(::TYPES[27/*Fuse.Drawing.Stroke*/]->Array(), 0);
        ::g::Fuse::Controls::Native::IShapeView::Update(uInterface(uPtr(ns), ::g::Fuse::Controls::Native::IShapeView_typeof()), fills, strokes, ::g::Fuse::ICommonViewport::PixelsPerPoint(uInterface(uPtr(Viewport()), ::TYPES[24/*Fuse.ICommonViewport*/])));
    }
}
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.6.0/Shapes/Star.Surface.uno
// ------------------------------------------------------------------------------------
...
{
    ::STRINGS[62] = uString::Const("Points");
    ::STRINGS[63] = uString::Const("Ratio");
    ::STRINGS[64] = uString::Const("RoundRatio");
    ::TYPES[35] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Drawing::LineSegment_typeof(), NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Controls::Shape_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Controls::Shape_type, interface1),
...
void Star::Points(int32_t value)
{
    ...
    _points = value;
    InvalidateSurfacePath();
    OnPropertyChanged(::g::Uno::UX::Selector__op_Implicit(::STRINGS[62/*"Points"*/]));
}
...
void Star::Ratio(float value)
{
    ...
    _ratio = value;
    InvalidateSurfacePath();
    OnPropertyChanged(::g::Uno::UX::Selector__op_Implicit(::STRINGS[63/*"Ratio"*/]));
}
...
void Star::RoundRatio(float value)
{
    ...
    _roundRatio = value;
    InvalidateSurfacePath();
    OnPropertyChanged(::g::Uno::UX::Selector__op_Implicit(::STRINGS[64/*"RoundRatio"*/]));
}
// }

// /usr/local/share/uno/Packages/Fuse.Controls.Panels/1.6.0/.uno/ux13/Fuse.Controls.GraphicsView.g.uno
// ---------------------------------------------------------------------------------------------------
...
{
    ::STRINGS[65] = uString::Const("AndroidAppearance");
    type->SetFields(2,
...
{
    ctor_(::STRINGS[65/*"AndroidAppe...*/], false);
    __parent1 = parent;
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.6.0/.uno/ux13/Fuse.Controls.TextControl.g.uno
// ------------------------------------------------------------------------------------------------------
...
{
    ::STRINGS[66] = uString::Const("iOSAppearance");
    type->SetFields(2,
...
{
    ctor_(::STRINGS[66/*"iOSAppearance"*/], false);
    __parent1 = parent;
    __parentInstance1 = parentInstance;
}
...
// /usr/local/share/uno/Packages/Fuse.Controls.Native/1.6.0/TextEnums.uno
// ----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.6.0/TextControls/TextControl.Forwarding.uno
// ----------------------------------------------------------------------------------------------------
...
// protected override sealed Fuse.VisualBounds CalcRenderBounds() :143
...
// protected void InvalidateRenderer() :74
...
// protected void InvalidateRenderer() [instance] :74
...
{
    float ret6;
    return (::g::Fuse::Visual__Get1_fn(this, ::TYPES[2/*Fuse.Visual*/]->MakeMethod(4/*Get<float>*/, ::g::Uno::Float_typeof(), NULL), uCRef<int32_t>(512), uCRef(1.0f), &ret6), ret6);
}
...
void TextControl::LineSpacing(float value)
{
    ...
    {
        ::g::Fuse::Visual__Set1_fn(this, ::TYPES[2/*Fuse.Visual*/]->MakeMethod(10/*Set<float>*/, ::g::Uno::Float_typeof(), NULL), uCRef<int32_t>(512), uCRef(value), uCRef(1.0f));
...
uString* TextControl::RenderValue()
{
    uString* ind1;
    ind1 = Value();
    return (ind1 != NULL) ? ind1 : ::STRINGS[11/*""*/];
}
...
{
    uString* newValue = (value != NULL) ? value : ::STRINGS[11/*""*/];
...
{
    int32_t ret7;
    return (::g::Fuse::Visual__Get1_fn(this, ::TYPES[2/*Fuse.Visual*/]->MakeMethod(4/*Get<Fuse.Controls.TextAlignment>*/, ::g::Fuse::Controls::TextAlignment_typeof(), NULL), uCRef<int32_t>(1024), uCRef<int32_t>(0), &ret7), ret7);
}
...
void TextControl::TextAlignment(int32_t value)
{
    ...
    {
        ::g::Fuse::Visual__Set1_fn(this, ::TYPES[2/*Fuse.Visual*/]->MakeMethod(10/*Set<Fuse.Controls.TextAlignment>*/, ::g::Fuse::Controls::TextAlignment_typeof(), NULL), uCRef<int32_t>(1024), uCRef<int32_t>(value), uCRef<int32_t>(0));
...
{
    int32_t ret8;
    return (::g::Fuse::Visual__Get1_fn(this, ::TYPES[2/*Fuse.Visual*/]->MakeMethod(4/*Get<Fuse.Controls.TextTruncation>*/, ::g::Fuse::Controls::TextTruncation_typeof(), NULL), uCRef<int32_t>(2048), uCRef<int32_t>(0), &ret8), ret8);
}
...
void TextControl::TextTruncation(int32_t value)
{
    ...
    {
        ::g::Fuse::Visual__Set1_fn(this, ::TYPES[2/*Fuse.Visual*/]->MakeMethod(10/*Set<Fuse.Controls.TextTruncation>*/, ::g::Fuse::Controls::TextTruncation_typeof(), NULL), uCRef<int32_t>(2048), uCRef<int32_t>(value_), uCRef<int32_t>(0));
...
{
    int32_t ret9;
    return (::g::Fuse::Visual__Get1_fn(this, ::TYPES[2/*Fuse.Visual*/]->MakeMethod(4/*Get<Fuse.Controls.TextWrapping>*/, ::g::Fuse::Controls::TextWrapping_typeof(), NULL), uCRef<int32_t>(2), uCRef<int32_t>(0), &ret9), ret9);
}
...
void TextControl::TextWrapping(int32_t value)
{
    ...
    {
        ::g::Fuse::Visual__Set1_fn(this, ::TYPES[2/*Fuse.Visual*/]->MakeMethod(10/*Set<Fuse.Controls.TextWrapping>*/, ::g::Fuse::Controls::TextWrapping_typeof(), NULL), uCRef<int32_t>(2), uCRef<int32_t>(value), uCRef<int32_t>(0));
...
{
    ValueChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(ValueChanged1, value), ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::TYPES[66/*string*/], NULL));
}
...
{
    ValueChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(ValueChanged1, value), ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::TYPES[66/*string*/], NULL));
}
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.6.0/ToggleControls/ToggleControl.uno
// ---------------------------------------------------------------------------------------------
...
{
    ::STRINGS[3] = uString::Const("Value");
    ::TYPES[45] = ::g::Fuse::Controls::Native::IToggleView_typeof();
    ::TYPES[46] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Uno::Bool_typeof(), NULL);
    type->SetInterfaces(
        ...
        ::g::Fuse::Triggers::Actions::IToggleable_typeof(), offsetof(ToggleControl_type, interface19));
    type->SetFields(112,
        ::g::Uno::Bool_typeof(), offsetof(ToggleControl, _value), 0,
        ::TYPES[46/*Uno.UX.ValueChangedHandler<bool>*/], offsetof(ToggleControl, ValueChanged1), 0,
...
ToggleControl_type* ToggleControl_typeof()
{
    ...
    type->interface19.fp_Toggle = (void(*)(uObject*))ToggleControl__Toggle_fn;
    type->interface17.fp_Draw = (void(*)(uObject*, ::g::Fuse::Drawing::Surface*))::g::Fuse::Controls::Panel__FuseDrawingISurfaceDrawableDraw_fn;
    type->interface17.fp_get_IsPrimary = (void(*)(uObject*, bool*))::g::Fuse::Controls::Panel__FuseDrawingISurfaceDrawableget_IsPrimary_fn;
    type->interface17.fp_get_ElementSize = (void(*)(uObject*, ::g::Uno::Float2*))::g::Fuse::Controls::Panel__FuseDrawingISurfaceDrawableget_ElementSize_fn;
    type->interface12.fp_Show = (void(*)(uObject*))::g::Fuse::Elements::Element__FuseTriggersActionsIShowShow_fn;
...
void ToggleControl__PushPropertiesToNativeView_fn(ToggleControl* __this)
{
    ...
    if (tv != NULL)
        ::g::Fuse::Controls::Native::IToggleView::Value(uInterface(uPtr(tv), ::TYPES[45/*Fuse.Controls.Native.IToggleView*/]), __this->Value());
}
...
void ToggleControl::SetValue(bool value, uObject* origin)
{
    if (_value != value)
    {
        ...
        if (origin != NULL)
        {
            ...
            if (tv != NULL)
                ::g::Fuse::Controls::Native::IToggleView::Value(uInterface(uPtr(tv), ::TYPES[45/*Fuse.Controls.Native.IToggleView*/]), value);
        }
    }
}
...
{
    return uAs<uObject*>(NativeView(), ::TYPES[45/*Fuse.Controls.Native.IToggleView*/]);
}
...
{
    ValueChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(ValueChanged1, value), ::TYPES[46/*Uno.UX.ValueChangedHandler<bool>*/]);
}
...
{
    ValueChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(ValueChanged1, value), ::TYPES[46/*Uno.UX.ValueChangedHandler<bool>*/]);
}
// }
...
{
    ::STRINGS[66] = uString::Const("iOSAppearance");
    ::TYPES[47] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Elements::Element_typeof(), ::g::Fuse::Controls::Native::ViewHandle_typeof(), NULL);
    ::TYPES[24] = ::g::Fuse::ICommonViewport_typeof();
    ::TYPES[11] = ::g::Fuse::Controls::Control_typeof();
    ::TYPES[3] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[26] = ::g::Fuse::Drawing::ISurfaceDrawable_typeof();
    ::TYPES[48] = ::g::Fuse::Controls::Native::ViewHandle_typeof();
    ::TYPES[49] = ::g::Fuse::Controls::Native::IView_typeof();
    type->SetDependencies(
        ::g::Fuse::Controls::Native::iOS::InputDispatch_typeof());
    type->SetInterfaces(
        ::g::Fuse::Elements::ITreeRenderer_typeof(), offsetof(TreeRenderer_type, interface0));
    type->SetFields(0,
        ::g::Uno::Action1_typeof()->MakeType(::TYPES[48/*Fuse.Controls.Native.ViewHandle*/], NULL), offsetof(TreeRenderer, _setRoot), 0,
        ::g::Uno::Action1_typeof()->MakeType(::TYPES[48/*Fuse.Controls.Native.ViewHandle*/], NULL), offsetof(TreeRenderer, _clearRoot), 0,
        ::TYPES[47/*Uno.Collections.Dictionary<Fuse.Elements.Element, Fuse.Controls.Native.ViewHandle>*/], offsetof(TreeRenderer, _elements), 0);
}
...
// public TreeRenderer(Uno.Action<Fuse.Controls.Native.ViewHandle> setRoot, Uno.Action<Fuse.Controls.Native.ViewHandle> clearRoot) :18
void TreeRenderer__ctor__fn(TreeRenderer* __this, uDelegate* setRoot, uDelegate* clearRoot)
{
    __this->ctor_(setRoot, clearRoot);
}

// private void Fuse.Elements.ITreeRenderer.BackgroundChanged(Fuse.Elements.Element e, Fuse.Drawing.Brush background) :70
...
// private void Fuse.Elements.ITreeRenderer.ClipToBoundsChanged(Fuse.Elements.Element e, bool clipToBounds) :112
...
// private void Fuse.Elements.ITreeRenderer.HitTestModeChanged(Fuse.Elements.Element e, bool enabled) :117
...
// private void Fuse.Elements.ITreeRenderer.IsEnabledChanged(Fuse.Elements.Element e, bool isEnabled) :101
...
// private void Fuse.Elements.ITreeRenderer.IsVisibleChanged(Fuse.Elements.Element e, bool isVisible) :96
...
// private bool Fuse.Elements.ITreeRenderer.Measure(Fuse.Elements.Element e, Fuse.LayoutParams lp, float2& size) :133
...
// private void Fuse.Elements.ITreeRenderer.OpacityChanged(Fuse.Elements.Element e, float opacity) :107
...
// private void Fuse.Elements.ITreeRenderer.Placed(Fuse.Elements.Element e) :87
void TreeRenderer__FuseElementsITreeRendererPlaced_fn(TreeRenderer* __this, ::g::Fuse::Elements::Element* e)
{
    ...
    ::g::Fuse::Controls::Native::ViewHandle* viewHandle = (::g::Uno::Collections::Dictionary__get_Item_fn(uPtr(__this->_elements), e, &ret10), ret10);

    if (uPtr(viewHandle)->NeedsRenderBounds)
        uPtr(viewHandle)->SetSizeAndVisualBounds(uPtr(e)->ActualSize(), uPtr(e)->RenderBoundsWithoutEffects());
    else
        uPtr(viewHandle)->SetSize1(uPtr(e)->ActualSize());
}

// private void Fuse.Elements.ITreeRenderer.Rooted(Fuse.Elements.Element e) :43
void TreeRenderer__FuseElementsITreeRendererRooted_fn(TreeRenderer* __this, ::g::Fuse::Elements::Element* e)
{
}

// private void Fuse.Elements.ITreeRenderer.RootingStarted(Fuse.Elements.Element e) :26
...
// private void Fuse.Elements.ITreeRenderer.TransformChanged(Fuse.Elements.Element e) :75
...
// private void Fuse.Elements.ITreeRenderer.Unrooted(Fuse.Elements.Element e) :45
...
// private void Fuse.Elements.ITreeRenderer.ZOrderChanged(Fuse.Elements.Element e, Fuse.Visual[] zorder) :123
...
// private object InstantiateTemplate(Fuse.Elements.Element e) :171
...
// private Fuse.Controls.Native.ViewHandle InstantiateView(Fuse.Elements.Element e) :143
...
// private object InstantiateViewOld(Fuse.Elements.Element e) :178
...
// public TreeRenderer New(Uno.Action<Fuse.Controls.Native.ViewHandle> setRoot, Uno.Action<Fuse.Controls.Native.ViewHandle> clearRoot) :18
...
// public TreeRenderer(Uno.Action<Fuse.Controls.Native.ViewHandle> setRoot, Uno.Action<Fuse.Controls.Native.ViewHandle> clearRoot) [instance] :18
void TreeRenderer::ctor_(uDelegate* setRoot, uDelegate* clearRoot)
{
    _elements = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[47/*Uno.Collections.Dictionary<Fuse.Elements.Element, Fuse.Controls.Native.ViewHandle>*/]));
    _setRoot = setRoot;
    _clearRoot = clearRoot;
}

// private object InstantiateTemplate(Fuse.Elements.Element e) [instance] :171
uObject* TreeRenderer::InstantiateTemplate(::g::Fuse::Elements::Element* e)
{
    ::g::Uno::UX::Template* t = uPtr(e)->FindTemplate(::STRINGS[66/*"iOSAppearance"*/]);
    return (t != NULL) ? (uObject*)uPtr(t)->New1() : NULL;
}

// private Fuse.Controls.Native.ViewHandle InstantiateView(Fuse.Elements.Element e) [instance] :143
::g::Fuse::Controls::Native::ViewHandle* TreeRenderer::InstantiateView(::g::Fuse::Elements::Element* e)
{
    uObject* ind1;
    uObject* sd = uAs<uObject*>(e, ::TYPES[26/*Fuse.Drawing.ISurfaceDrawable*/]);

    if ((sd != NULL) && ::g::Fuse::Drawing::ISurfaceDrawable::IsPrimary(uInterface(uPtr(sd), ::TYPES[26/*Fuse.Drawing.ISurfaceDrawable*/])))
        return ::g::Fuse::Controls::Native::iOS::CanvasViewGroup::New3(sd, ::g::Fuse::ICommonViewport::PixelsPerPoint(uInterface(uPtr(uPtr(e)->Viewport()), ::TYPES[24/*Fuse.ICommonViewport*/])));

    ::g::Fuse::Controls::Native::ViewHandle* result = NULL;
    ::g::Fuse::Controls::Native::ViewHandle* appearance = uAs< ::g::Fuse::Controls::Native::ViewHandle*>((ind1 = InstantiateTemplate(e), (ind1 != NULL) ? ind1 : (uObject*)InstantiateViewOld(e)), ::TYPES[48/*Fuse.Controls.Native.ViewHandle*/]);
    ...
    if (appearance != NULL)
    {
        if (uIs(e, ::TYPES[11/*Fuse.Controls.Control*/]))
        {
            ...
            if (uIs(appearance, ::TYPES[49/*Fuse.Controls.Native.IView*/]))
...
// private object InstantiateViewOld(Fuse.Elements.Element e) [instance] :178
...
// public TreeRenderer New(Uno.Action<Fuse.Controls.Native.ViewHandle> setRoot, Uno.Action<Fuse.Controls.Native.ViewHandle> clearRoot) [static] :18
...
{
    ::TYPES[50] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Controls::Native::ViewHandle_typeof(), NULL);
    ::TYPES[51] = ::g::Fuse::Controls::INativeViewRoot_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Controls::Panel_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Controls::Panel_type, interface1),
        ::g::Fuse::IProperties_typeof(), offsetof(::g::Fuse::Controls::Panel_type, interface2),
    ...
    type->SetFields(112,
        ...
        ::TYPES[51/*Fuse.Controls.INativeViewRoot*/], offsetof(TreeRendererPanel, _nativeViewHost), 0);
}
...
void TreeRendererPanel::ctor_7(uObject* nativeViewHost)
{
    ...
    _treeRenderer = ::g::Fuse::Controls::TreeRenderer::New1(uDelegate::New(::TYPES[50/*Uno.Action<Fuse.Controls.Native.ViewHandle>*/], (void*)TreeRendererPanel__SetRoot_fn, this), uDelegate::New(::TYPES[50/*Uno.Action<Fuse.Controls.Native.ViewHandle>*/], (void*)TreeRendererPanel__ClearRoot_fn, this));
}
...
{
    ::g::Fuse::Controls::INativeViewRoot::Remove(uInterface(uPtr(_nativeViewHost), ::TYPES[51/*Fuse.Controls.INativeViewRoot*/]), viewHandle);
}
...
{
    ::g::Fuse::Controls::INativeViewRoot::Add(uInterface(uPtr(_nativeViewHost), ::TYPES[51/*Fuse.Controls.INativeViewRoot*/]), viewHandle);
}
...
// /usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/NavigationControl.Pages.uno
// ----------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.WebView/1.6.0/URISchemeEventArgs.uno
// --------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Video/1.6.0/Video.ScriptClass.uno
// -----------------------------------------------------------------------------
...
{
    ::g::Fuse::Scripting::ScriptClass_typeof()->Init();
    Video::_positionName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[67/*"Position"*/]);
    Video::_durationName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[68/*"Duration"*/]);
    Video::_progressName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[69/*"Progress"*/]);
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[19/*Fuse.Scripting.ScriptMember[]*/], 4, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New4(::TYPES[52/*Fuse.Scripting.ScriptMethod<Fuse.Controls.Video>*/], ::STRINGS[70/*"getDuration"*/], uDelegate::New(::TYPES[53/*Uno.Func<Fuse.Scripting.Context, Fuse.Controls.Video, object[], object>*/], (void*)Video__getDuration_fn)), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New3(::TYPES[52/*Fuse.Scripting.ScriptMethod<Fuse.Controls.Video>*/], ::STRINGS[71/*"resume"*/], uDelegate::New(::TYPES[54/*Uno.Action<Fuse.Controls.Video>*/], (void*)Video__resume_fn)), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New3(::TYPES[52/*Fuse.Scripting.ScriptMethod<Fuse.Controls.Video>*/], ::STRINGS[72/*"pause"*/], uDelegate::New(::TYPES[54/*Uno.Action<Fuse.Controls.Video>*/], (void*)Video__pause_fn)), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New3(::TYPES[52/*Fuse.Scripting.ScriptMethod<Fuse.Controls.Video>*/], ::STRINGS[73/*"stop"*/], uDelegate::New(::TYPES[54/*Uno.Action<Fuse.Controls.Video>*/], (void*)Video__stop_fn))));
}

static void Video_build(uType* type)
{
    ::STRINGS[67] = uString::Const("Position");
    ::STRINGS[68] = uString::Const("Duration");
    ::STRINGS[69] = uString::Const("Progress");
    ::STRINGS[70] = uString::Const("getDuration");
    ::STRINGS[71] = uString::Const("resume");
    ::STRINGS[72] = uString::Const("pause");
    ::STRINGS[73] = uString::Const("stop");
    ::STRINGS[74] = uString::Const("getDuration takes 0 arguments, but ");
    ::STRINGS[75] = uString::Const(" was supplied");
    ::STRINGS[76] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Video/1.6.0/Video.ScriptClass.uno");
    ::TYPES[18] = ::g::Uno::Type_typeof();
    ::TYPES[19] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[52] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(type, NULL);
    ::TYPES[53] = ::g::Uno::Func3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), type, uObject_typeof()->Array(), uObject_typeof(), NULL);
    ::TYPES[54] = ::g::Uno::Action1_typeof()->MakeType(type, NULL);
    ::TYPES[55] = ::g::Uno::UX::ValueChangedArgs_typeof()->MakeType(::g::Uno::Double_typeof(), NULL);
    ::TYPES[5] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[56] = ::g::Fuse::Visual_typeof()->MakeMethod(8/*RemoveAllChildren<Fuse.Controls.VideoImpl.VideoVisual>*/, ::g::Fuse::Controls::VideoImpl::VideoVisual_typeof(), NULL);
    ::TYPES[57] = ::g::Fuse::Triggers::IPlayback_typeof();
    ::TYPES[58] = ::g::Fuse::Triggers::IMediaPlayback_typeof();
    ::TYPES[59] = ::g::Fuse::Triggers::IProgress_typeof();
    ::TYPES[17] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Uno::Double_typeof(), NULL);
    ::TYPES[16] = ::g::Uno::EventHandler_typeof();
    type->SetDependencies(
        ::g::Uno::EventArgs_typeof());
    type->SetInterfaces(
        ...
        ::TYPES[58/*Fuse.Triggers.IMediaPlayback*/], offsetof(Video_type, interface18),
        ::TYPES[57/*Fuse.Triggers.IPlayback*/], offsetof(Video_type, interface19),
        ::TYPES[59/*Fuse.Triggers.IProgress*/], offsetof(Video_type, interface20));
    type->SetFields(112,
        ...
        ::TYPES[58/*Fuse.Triggers.IMediaPlayback*/], offsetof(Video, _playback), 0,
...
{
    __this->RemoveAllChildren(::TYPES[56/*Fuse.Visual.RemoveAllChildren<Fuse.Controls.VideoImpl.VideoVisual>*/]);
    ::g::Fuse::Controls::Panel__OnUnrooted_fn(__this);
}
...
{
    return (Playback() != NULL) ? ::g::Fuse::Triggers::IMediaPlayback::Duration(uInterface(uPtr(Playback()), ::TYPES[58/*Fuse.Triggers.IMediaPlayback*/])) : 0.0;
}
...
void Video::OnProgressChanged(uObject* sender, ::g::Uno::EventArgs* args)
{
    ...
    if (::g::Uno::Delegate::op_Inequality(ProgressChanged1, NULL))
        uPtr(ProgressChanged1)->Invoke(2, this, (::g::Uno::UX::ValueChangedArgs__New2_fn(::TYPES[55/*Uno.UX.ValueChangedArgs<double>*/], uCRef(Progress()), &ret2), ret2));
}
...
{
    if (Playback() != NULL)
        ::g::Fuse::Triggers::IPlayback::Pause(uInterface(uPtr(Playback()), ::TYPES[57/*Fuse.Triggers.IPlayback*/]));
}
...
{
    if (_playback != NULL)
        ::g::Fuse::Triggers::IProgress::remove_ProgressChanged(uInterface(uPtr(_playback), ::TYPES[59/*Fuse.Triggers.IProgress*/]), uDelegate::New(::TYPES[17/*Uno.UX.ValueChangedHandler<double>*/], (void*)Video__OnProgressChanged_fn, this));

    _playback = value;

    if (_playback != NULL)
        ::g::Fuse::Triggers::IProgress::add_ProgressChanged(uInterface(uPtr(_playback), ::TYPES[59/*Fuse.Triggers.IProgress*/]), uDelegate::New(::TYPES[17/*Uno.UX.ValueChangedHandler<double>*/], (void*)Video__OnProgressChanged_fn, this));
...
{
    if (Playback() != NULL)
        ::g::Fuse::Triggers::IPlayback::PlayTo(uInterface(uPtr(Playback()), ::TYPES[57/*Fuse.Triggers.IPlayback*/]), progress);
}

// public new double get_Position() [instance] :452
double Video::Position()
{
    return (Playback() != NULL) ? ::g::Fuse::Triggers::IMediaPlayback::Position(uInterface(uPtr(Playback()), ::TYPES[58/*Fuse.Triggers.IMediaPlayback*/])) : 0.0;
}
...
{
    if (Playback() != NULL)
        ::g::Fuse::Triggers::IMediaPlayback::Position(uInterface(uPtr(Playback()), ::TYPES[58/*Fuse.Triggers.IMediaPlayback*/]), value);
}

// public double get_Progress() [instance] :445
double Video::Progress()
{
    return (Playback() != NULL) ? ::g::Fuse::Triggers::IPlayback::Progress(uInterface(uPtr(uAs<uObject*>(Playback(), ::TYPES[57/*Fuse.Triggers.IPlayback*/])), ::TYPES[57/*Fuse.Triggers.IPlayback*/])) : 0.0;
}
...
{
    if (Playback() != NULL)
        ::g::Fuse::Triggers::IPlayback::Progress(uInterface(uPtr(uAs<uObject*>(Playback(), ::TYPES[57/*Fuse.Triggers.IPlayback*/])), ::TYPES[57/*Fuse.Triggers.IPlayback*/]), value);
}
...
{
    if (Playback() != NULL)
        ::g::Fuse::Triggers::IPlayback::Resume(uInterface(uPtr(Playback()), ::TYPES[57/*Fuse.Triggers.IPlayback*/]));
}
...
{
    if (Playback() != NULL)
        ::g::Fuse::Triggers::IPlayback::Stop(uInterface(uPtr(Playback()), ::TYPES[57/*Fuse.Triggers.IPlayback*/]));
}
...
uObject* Video::getDuration(::g::Fuse::Scripting::Context* c, Video* v, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[74/*"getDuration...*/], uBox<int32_t>(::g::Uno::Int_typeof(), uPtr(args)->Length())), ::STRINGS[75/*" was supplied"*/]), v, ::STRINGS[76/*"/usr/local/...*/], 38, ::STRINGS[70/*"getDuration"*/], NULL);
        return NULL;
    }
...
{
    ::g::Fuse::Scripting::ScriptClass_typeof()->Init();
    WebView::_urlName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[77/*"Url"*/]);
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[19/*Fuse.Scripting.ScriptMember[]*/], 7, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New2(::TYPES[60/*Fuse.Scripting.ScriptMethod<Fuse.Controls.WebView>*/], ::STRINGS[46/*"goto"*/], uDelegate::New(::TYPES[61/*Uno.Action<Fuse.Controls.WebView, object[]>*/], (void*)WebView__setUrl_fn)), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New3(::TYPES[60/*Fuse.Scripting.ScriptMethod<Fuse.Controls.WebView>*/], ::STRINGS[78/*"goBack"*/], uDelegate::New(::TYPES[62/*Uno.Action<Fuse.Controls.WebView>*/], (void*)WebView__goBack_fn)), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New3(::TYPES[60/*Fuse.Scripting.ScriptMethod<Fuse.Controls.WebView>*/], ::STRINGS[79/*"goForward"*/], uDelegate::New(::TYPES[62/*Uno.Action<Fuse.Controls.WebView>*/], (void*)WebView__goForward_fn)), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New3(::TYPES[60/*Fuse.Scripting.ScriptMethod<Fuse.Controls.WebView>*/], ::STRINGS[12/*"reload"*/], uDelegate::New(::TYPES[62/*Uno.Action<Fuse.Controls.WebView>*/], (void*)WebView__reload_fn)), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New3(::TYPES[60/*Fuse.Scripting.ScriptMethod<Fuse.Controls.WebView>*/], ::STRINGS[73/*"stop"*/], uDelegate::New(::TYPES[62/*Uno.Action<Fuse.Controls.WebView>*/], (void*)WebView__stop_fn)), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New2(::TYPES[60/*Fuse.Scripting.ScriptMethod<Fuse.Controls.WebView>*/], ::STRINGS[80/*"loadHtml"*/], uDelegate::New(::TYPES[61/*Uno.Action<Fuse.Controls.WebView, object[]>*/], (void*)WebView__loadHtml_fn)), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New2(::TYPES[60/*Fuse.Scripting.ScriptMethod<Fuse.Controls.WebView>*/], ::STRINGS[81/*"setBaseUrl"*/], uDelegate::New(::TYPES[61/*Uno.Action<Fuse.Controls.WebView, object[]>*/], (void*)WebView__setBaseUrl_fn))));
}

static void WebView_build(uType* type)
{
    ::STRINGS[77] = uString::Const("Url");
    ::STRINGS[46] = uString::Const("goto");
    ::STRINGS[78] = uString::Const("goBack");
    ::STRINGS[79] = uString::Const("goForward");
    ::STRINGS[12] = uString::Const("reload");
    ::STRINGS[73] = uString::Const("stop");
    ::STRINGS[80] = uString::Const("loadHtml");
    ::STRINGS[81] = uString::Const("setBaseUrl");
    ::STRINGS[11] = uString::Const("");
    ::STRINGS[82] = uString::Const("WebView.loadHtml takes either one url argument, or an url and a baseUrl argument");
    ::STRINGS[83] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.WebView/1.6.0/WebView.ScriptClass.uno");
    ::STRINGS[84] = uString::Const("about:blank");
    ::STRINGS[85] = uString::Const(":");
    ::STRINGS[86] = uString::Const("WebView.setBaseUrl requires 1 string argument");
    ::STRINGS[87] = uString::Const("WebView.setUrl requires 1 string argument");
    ::STRINGS[88] = uString::Const("setUrl");
    ::STRINGS[89] = uString::Const("ScrollEnabled cannot be changed once rooted");
    ::STRINGS[90] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.WebView/1.6.0/WebView.uno");
    ::STRINGS[91] = uString::Const("ZoomEnabled cannot be changed once rooted");
    ::TYPES[18] = ::g::Uno::Type_typeof();
    ::TYPES[19] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[60] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(type, NULL);
    ::TYPES[61] = ::g::Uno::Action2_typeof()->MakeType(type, uObject_typeof()->Array(), NULL);
    ::TYPES[62] = ::g::Uno::Action1_typeof()->MakeType(type, NULL);
    ::TYPES[63] = ::g::Fuse::Controls::FallbackWebViewClient_typeof();
    ::TYPES[64] = ::g::Uno::String_typeof()->Array();
    ::TYPES[25] = ::g::Fuse::Controls::IWebView_typeof();
    ::TYPES[65] = ::g::Fuse::Navigation::IBaseNavigation_typeof();
    ::TYPES[66] = ::g::Uno::String_typeof();
    ::TYPES[55] = ::g::Uno::UX::ValueChangedArgs_typeof()->MakeType(::g::Uno::Double_typeof(), NULL);
    ::TYPES[59] = ::g::Fuse::Triggers::IProgress_typeof();
    ::TYPES[67] = ::g::Fuse::Controls::ISourceReceiver_typeof();
    ::TYPES[17] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Uno::Double_typeof(), NULL);
    ::TYPES[16] = ::g::Uno::EventHandler_typeof();
    ::TYPES[68] = ::g::Fuse::Navigation::HistoryChangedHandler_typeof();
    type->SetDependencies(
    ...
    type->SetInterfaces(
        ...
        ::TYPES[25/*Fuse.Controls.IWebView*/], offsetof(WebView_type, interface18),
        ::TYPES[59/*Fuse.Triggers.IProgress*/], offsetof(WebView_type, interface19),
        ::TYPES[65/*Fuse.Navigation.IBaseNavigation*/], offsetof(WebView_type, interface20),
        ::TYPES[67/*Fuse.Controls.ISourceReceiver*/], offsetof(WebView_type, interface21));
    type->SetFields(112,
        ::TYPES[25/*Fuse.Controls.IWebView*/], offsetof(WebView, _fallbackClient), 0,
        ::TYPES[25/*Fuse.Controls.IWebView*/], offsetof(WebView, _webViewClient), 0,
        ::TYPES[16/*Uno.EventHandler*/], offsetof(WebView, BeginLoading1), 0,
        ::TYPES[68/*Fuse.Navigation.HistoryChangedHandler*/], offsetof(WebView, HistoryChanged1), 0,
...
{
    uObject* ret4;
    uString* scheme = ::STRINGS[11/*""*/];
    scheme = WebView::PreprocUriScheme(scheme);
    uArray* schemes = ::g::Uno::String::op_Inequality(scheme, ::STRINGS[11/*""*/]) ? uArray::Init<uString*>(::TYPES[64/*string[]*/], 1, scheme) : uArray::Init<uString*>(::TYPES[64/*string[]*/], 0);
...
{
    ::g::Fuse::Controls::FallbackWebViewClient* fbc = uAs< ::g::Fuse::Controls::FallbackWebViewClient*>(_fallbackClient, ::TYPES[63/*Fuse.Controls.FallbackWebViewClient*/]);
...
{
    return ::g::Fuse::Controls::IWebView::BaseUrl(uInterface(uPtr(WebViewClient()), ::TYPES[25/*Fuse.Controls.IWebView*/]));
}

// public void set_BaseUrl(string value) [instance] :356
void WebView::BaseUrl(uString* value)
{
    ::g::Fuse::Controls::IWebView::BaseUrl(uInterface(uPtr(WebViewClient()), ::TYPES[25/*Fuse.Controls.IWebView*/]), (value != NULL) ? value : ::STRINGS[11/*""*/]);
}
...
{
    return ::g::Fuse::Navigation::IBaseNavigation::CanGoBack(uInterface(uPtr(WebViewClient()), ::TYPES[65/*Fuse.Navigation.IBaseNavigation*/]));
}

// public bool get_CanGoForward() [instance] :409
bool WebView::CanGoForward()
{
    return ::g::Fuse::Navigation::IBaseNavigation::CanGoForward(uInterface(uPtr(WebViewClient()), ::TYPES[65/*Fuse.Navigation.IBaseNavigation*/]));
}

// public void Eval(string js) [instance] :412
void WebView::Eval(uString* js)
{
    ::g::Fuse::Controls::IWebView::Eval(uInterface(uPtr(WebViewClient()), ::TYPES[25/*Fuse.Controls.IWebView*/]), (js != NULL) ? js : ::STRINGS[11/*""*/]);
}
...
{
    ::g::Fuse::Controls::IWebView::Eval1(uInterface(uPtr(WebViewClient()), ::TYPES[25/*Fuse.Controls.IWebView*/]), (js != NULL) ? js : ::STRINGS[11/*""*/], resultHandler);
}

// public Uno.UX.FileSource get_File() [instance] :398
::g::Uno::UX::FileSource* WebView::File()
{
    return ::g::Fuse::Controls::IWebView::File(uInterface(uPtr(WebViewClient()), ::TYPES[25/*Fuse.Controls.IWebView*/]));
}

// public void set_File(Uno.UX.FileSource value) [instance] :399
void WebView::File(::g::Uno::UX::FileSource* value)
{
    ::g::Fuse::Controls::IWebView::File(uInterface(uPtr(WebViewClient()), ::TYPES[25/*Fuse.Controls.IWebView*/]), value);
}

// public void GoBack() [instance] :422
void WebView::GoBack()
{
    ::g::Fuse::Navigation::IBaseNavigation::GoBack(uInterface(uPtr(WebViewClient()), ::TYPES[65/*Fuse.Navigation.IBaseNavigation*/]));
}

// public void GoForward() [instance] :427
void WebView::GoForward()
{
    ::g::Fuse::Navigation::IBaseNavigation::GoForward(uInterface(uPtr(WebViewClient()), ::TYPES[65/*Fuse.Navigation.IBaseNavigation*/]));
}
...
{
    HistoryChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(HistoryChanged1, value), ::TYPES[68/*Fuse.Navigation.HistoryChangedHandler*/]);
}
...
{
    HistoryChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(HistoryChanged1, value), ::TYPES[68/*Fuse.Navigation.HistoryChangedHandler*/]);
}

// public void LoadHtml(string html) [instance] :345
void WebView::LoadHtml(uString* html)
{
    ::g::Fuse::Controls::IWebView::LoadHtml(uInterface(uPtr(WebViewClient()), ::TYPES[25/*Fuse.Controls.IWebView*/]), (html != NULL) ? html : ::STRINGS[11/*""*/]);
}

// public void LoadHtml(string html, string baseUrl) [instance] :341
void WebView::LoadHtml1(uString* html, uString* baseUrl)
{
    ::g::Fuse::Controls::IWebView::LoadHtml1(uInterface(uPtr(WebViewClient()), ::TYPES[25/*Fuse.Controls.IWebView*/]), (html != NULL) ? html : ::STRINGS[11/*""*/], baseUrl);
}

// public void LoadUrl(string url) [instance] :442
void WebView::LoadUrl(uString* url)
{
    ::g::Fuse::Controls::IWebView::LoadUrl(uInterface(uPtr(WebViewClient()), ::TYPES[25/*Fuse.Controls.IWebView*/]), (url != NULL) ? url : ::STRINGS[84/*"about:blank"*/]);
}
...
void WebView::OnProgressChanged(uObject* sender, ::g::Uno::EventArgs* args)
{
    ...
    if (::g::Uno::Delegate::op_Inequality(ProgressChanged1, NULL))
        uPtr(ProgressChanged1)->Invoke(2, this, (::g::Uno::UX::ValueChangedArgs__New2_fn(::TYPES[55/*Uno.UX.ValueChangedArgs<double>*/], uCRef(Progress()), &ret5), ret5));
}
...
{
    return ::g::Fuse::Triggers::IProgress::Progress(uInterface(uPtr(WebViewClient()), ::TYPES[59/*Fuse.Triggers.IProgress*/]));
}
...
void WebView::Reload()
{
    ::g::Fuse::Controls::IWebView::Reload(uInterface(uPtr(WebViewClient()), ::TYPES[25/*Fuse.Controls.IWebView*/]));
}

// public bool get_ScrollEnabled() [instance] :302
bool WebView::ScrollEnabled()
{
    return ::g::Fuse::Controls::IWebView::ScrollEnabled(uInterface(uPtr(WebViewClient()), ::TYPES[25/*Fuse.Controls.IWebView*/]));
}
...
void WebView::ScrollEnabled(bool value)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log3(::STRINGS[89/*"ScrollEnabl...*/], 0, ::STRINGS[90/*"/usr/local/...*/], 297);
        return;
    }

    ::g::Fuse::Controls::IWebView::ScrollEnabled(uInterface(uPtr(WebViewClient()), ::TYPES[25/*Fuse.Controls.IWebView*/]), value);
}
...
void WebView::SetUrl(uString* value, uObject* origin)
{
    ...
    ::g::Fuse::Controls::IWebView::Url(uInterface(uPtr(WebViewClient()), ::TYPES[25/*Fuse.Controls.IWebView*/]), value);
    UpdateRestState();
}
...
{
    return ::g::Fuse::Controls::ISourceReceiver::Source(uInterface(uPtr(WebViewClient()), ::TYPES[67/*Fuse.Controls.ISourceReceiver*/]));
}

// public void set_Source(string value) [instance] :365
void WebView::Source(uString* value)
{
    ::g::Fuse::Controls::ISourceReceiver::Source(uInterface(uPtr(WebViewClient()), ::TYPES[67/*Fuse.Controls.ISourceReceiver*/]), (value != NULL) ? value : ::STRINGS[11/*""*/]);
}

// public void Stop() [instance] :437
void WebView::Stop()
{
    ::g::Fuse::Controls::IWebView::Stop(uInterface(uPtr(WebViewClient()), ::TYPES[25/*Fuse.Controls.IWebView*/]));
}
...
uString* WebView::Url()
{
    return ::g::Fuse::Controls::IWebView::Url(uInterface(uPtr(WebViewClient()), ::TYPES[25/*Fuse.Controls.IWebView*/]));
}

// public void set_Url(string value) [instance] :390
void WebView::Url(uString* value)
{
    SetUrl((value != NULL) ? value : ::STRINGS[84/*"about:blank"*/], (uObject*)this);
}
...
{
    uString* ind2;
    uString* url = ::STRINGS[84/*"about:blank"*/];
    uString* source = ::STRINGS[11/*""*/];
    ...
    {
        ::g::Fuse::Triggers::IProgress::remove_ProgressChanged(uInterface(uPtr(_webViewClient), ::TYPES[59/*Fuse.Triggers.IProgress*/]), uDelegate::New(::TYPES[17/*Uno.UX.ValueChangedHandler<double>*/], (void*)WebView__OnProgressChanged_fn, this));
        ::g::Fuse::Controls::IWebView::remove_PageLoaded(uInterface(uPtr(_webViewClient), ::TYPES[25/*Fuse.Controls.IWebView*/]), uDelegate::New(::TYPES[16/*Uno.EventHandler*/], (void*)WebView__OnPageLoaded_fn, this));
        ::g::Fuse::Controls::IWebView::remove_BeginLoading(uInterface(uPtr(_webViewClient), ::TYPES[25/*Fuse.Controls.IWebView*/]), uDelegate::New(::TYPES[16/*Uno.EventHandler*/], (void*)WebView__OnBeginLoading_fn, this));
        ::g::Fuse::Controls::IWebView::remove_UrlChanged(uInterface(uPtr(_webViewClient), ::TYPES[25/*Fuse.Controls.IWebView*/]), uDelegate::New(::TYPES[16/*Uno.EventHandler*/], (void*)WebView__OnPageChanged_fn, this));
        ::g::Fuse::Controls::IWebView::remove_URISchemeHandler(uInterface(uPtr(_webViewClient), ::TYPES[25/*Fuse.Controls.IWebView*/]), URISchemeHandler1);
        url = ::g::Fuse::Controls::IWebView::Url(uInterface(uPtr(_webViewClient), ::TYPES[25/*Fuse.Controls.IWebView*/]));
        source = (ind2 = ::g::Fuse::Controls::ISourceReceiver::Source(uInterface(uPtr(_webViewClient), ::TYPES[67/*Fuse.Controls.ISourceReceiver*/])), (ind2 != NULL) ? ind2 : ::STRINGS[11/*""*/]);
        baseUrl = ::g::Fuse::Controls::IWebView::BaseUrl(uInterface(uPtr(_webViewClient), ::TYPES[25/*Fuse.Controls.IWebView*/]));
        file = ::g::Fuse::Controls::IWebView::File(uInterface(uPtr(_webViewClient), ::TYPES[25/*Fuse.Controls.IWebView*/]));
        zoomEnabled = ::g::Fuse::Controls::IWebView::ZoomEnabled(uInterface(uPtr(_webViewClient), ::TYPES[25/*Fuse.Controls.IWebView*/]));
        scrollEnabled = ::g::Fuse::Controls::IWebView::ScrollEnabled(uInterface(uPtr(_webViewClient), ::TYPES[25/*Fuse.Controls.IWebView*/]));
    }
    ...
    if (_webViewClient != NULL)
    {
        ::g::Fuse::Triggers::IProgress::add_ProgressChanged(uInterface(uPtr(_webViewClient), ::TYPES[59/*Fuse.Triggers.IProgress*/]), uDelegate::New(::TYPES[17/*Uno.UX.ValueChangedHandler<double>*/], (void*)WebView__OnProgressChanged_fn, this));
        ::g::Fuse::Controls::IWebView::add_PageLoaded(uInterface(uPtr(_webViewClient), ::TYPES[25/*Fuse.Controls.IWebView*/]), uDelegate::New(::TYPES[16/*Uno.EventHandler*/], (void*)WebView__OnPageLoaded_fn, this));
        ::g::Fuse::Controls::IWebView::add_BeginLoading(uInterface(uPtr(_webViewClient), ::TYPES[25/*Fuse.Controls.IWebView*/]), uDelegate::New(::TYPES[16/*Uno.EventHandler*/], (void*)WebView__OnBeginLoading_fn, this));
        ::g::Fuse::Controls::IWebView::add_UrlChanged(uInterface(uPtr(_webViewClient), ::TYPES[25/*Fuse.Controls.IWebView*/]), uDelegate::New(::TYPES[16/*Uno.EventHandler*/], (void*)WebView__OnPageChanged_fn, this));
        ::g::Fuse::Controls::IWebView::add_URISchemeHandler(uInterface(uPtr(_webViewClient), ::TYPES[25/*Fuse.Controls.IWebView*/]), URISchemeHandler1);
        ::g::Fuse::Controls::IWebView::BaseUrl(uInterface(uPtr(_webViewClient), ::TYPES[25/*Fuse.Controls.IWebView*/]), baseUrl);
        ::g::Fuse::Controls::ISourceReceiver::Source(uInterface(uPtr(_webViewClient), ::TYPES[67/*Fuse.Controls.ISourceReceiver*/]), source);
        ::g::Fuse::Controls::IWebView::ZoomEnabled(uInterface(uPtr(_webViewClient), ::TYPES[25/*Fuse.Controls.IWebView*/]), zoomEnabled);
        ::g::Fuse::Controls::IWebView::ScrollEnabled(uInterface(uPtr(_webViewClient), ::TYPES[25/*Fuse.Controls.IWebView*/]), scrollEnabled);

        if (::g::Uno::String::op_Equality(source, ::STRINGS[11/*""*/]))
            ::g::Fuse::Controls::IWebView::Url(uInterface(uPtr(_webViewClient), ::TYPES[25/*Fuse.Controls.IWebView*/]), url);

        ::g::Fuse::Controls::IWebView::File(uInterface(uPtr(_webViewClient), ::TYPES[25/*Fuse.Controls.IWebView*/]), file);
...
{
    return ::g::Fuse::Controls::IWebView::ZoomEnabled(uInterface(uPtr(WebViewClient()), ::TYPES[25/*Fuse.Controls.IWebView*/]));
}
...
void WebView::ZoomEnabled(bool value)
{
    if (WebViewClient() != _fallbackClient)
    {
        ::g::Uno::Diagnostics::Debug::Log3(::STRINGS[91/*"ZoomEnabled...*/], 0, ::STRINGS[90/*"/usr/local/...*/], 282);
        return;
    }

    ::g::Fuse::Controls::IWebView::ZoomEnabled(uInterface(uPtr(WebViewClient()), ::TYPES[25/*Fuse.Controls.IWebView*/]), value);
}
...
void WebView::loadHtml(WebView* view, uArray* args)
{
    ...
    switch (uPtr(args)->Length())
    {
        case 1:
        {
            uPtr(view)->LoadHtml(uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[66/*string*/]));
            return;
        }
        case 2:
        {
            uPtr(view)->LoadHtml1(uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[66/*string*/]), uAs<uString*>(uPtr(args)->Strong<uObject*>(1), ::TYPES[66/*string*/]));
            return;
        }
        default:
        {
            ::g::Fuse::Diagnostics::UserError(::STRINGS[82/*"WebView.loa...*/], view, ::STRINGS[83/*"/usr/local/...*/], 47, ::STRINGS[80/*"loadHtml"*/], NULL);
            return;
        }
    }
}
...
{
    WebView_typeof()->Init();
    return ::g::Uno::String::Contains(uPtr(inScheme), ::STRINGS[85/*":"*/]) ? inScheme : (uString*)::g::Uno::String::op_Addition2(inScheme, ::STRINGS[85/*":"*/]);
}
...
void WebView::setBaseUrl(WebView* view, uArray* args)
{
    ...
    switch (uPtr(args)->Length())
    {
        case 1:
        {
            uPtr(view)->BaseUrl(uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[66/*string*/]));
            return;
        }
        default:
        {
            ::g::Fuse::Diagnostics::UserError(::STRINGS[86/*"WebView.set...*/], view, ::STRINGS[83/*"/usr/local/...*/], 127, ::STRINGS[81/*"setBaseUrl"*/], NULL);
            return;
        }
    }
}
...
void WebView::setUrl(WebView* view, uArray* args)
{
    ...
    switch (uPtr(args)->Length())
    {
        case 1:
        {
            uPtr(view)->Url(uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[66/*string*/]));
            return;
        }
        default:
        {
            ::g::Fuse::Diagnostics::UserError(::STRINGS[87/*"WebView.set...*/], view, ::STRINGS[83/*"/usr/local/...*/], 108, ::STRINGS[88/*"setUrl"*/], NULL);
            return;
        }
    }
}
