// This file was generated based on /usr/local/share/uno/Packages/Fuse.Controls.Native/1.6.0/iOS/Shape.uno.
...
static void Shape_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Native/1.6.0/iOS/Shape.uno");
...
void Shape__MakeLayers_fn(::g::ObjC::Object* handle, int32_t* layerCount)
{
...
void Shape__SetBrush_fn(Shape* __this, ::g::Fuse::Drawing::Brush* brush, int32_t* layer, ::g::ObjC::Object* path, bool* isLine, float* strokeWidth)
{
...
void Shape__SetBrush1_fn(::g::ObjC::Object* handle, float* r, float* g, float* b, float* a, int32_t* layerIndex, ::g::ObjC::Object* pathHandle, bool* isLine, float* strokeWidth, float* opacity)
{
...
void Shape__SetLinearGradient_fn(Shape* __this, ::g::Fuse::Drawing::LinearGradient* gradient, int32_t* layer, ::g::ObjC::Object* path, bool* isLine, float* strokeWidth)
{
...
void Shape__SetLinearGradient1_fn(::g::ObjC::Object* handle, int32_t* layerIndex, ::g::ObjC::Object* pathHandle, bool* isLine, float* strokeWidth, float* startX, float* startY, float* endX, float* endY, uArray* colors, uArray* offsets, float* width, float* height)
{
...
void Shape::OnShapeChanged()
{
    ...
    if (_fills != NULL)
        ...
        for (int32_t i = 0; i < uPtr(_fills)->Length(); i++)
            SetBrush(uPtr(_fills)->Strong< ::g::Fuse::Drawing::Brush*>(i), layer++, path, false, 0.0f);

    if (_strokes != NULL)

        for (int32_t i1 = 0; i1 < uPtr(_strokes)->Length(); i1++)
        {
...
void Shape::SetBrush(::g::Fuse::Drawing::Brush* brush, int32_t layer, ::g::ObjC::Object* path, bool isLine, float strokeWidth)
{
...
void Shape::SetLinearGradient(::g::Fuse::Drawing::LinearGradient* gradient, int32_t layer, ::g::ObjC::Object* path, bool isLine, float strokeWidth)
{
...
void Shape::MakeLayers(::g::ObjC::Object* handle, int32_t layerCount)
{
    @autoreleasepool
    {
        [] (::id handle, int32_t layerCount) -> void
        {
...
void Shape::SetBrush1(::g::ObjC::Object* handle, float r, float g, float b, float a, int32_t layerIndex, ::g::ObjC::Object* pathHandle, bool isLine, float strokeWidth, float opacity)
{
    @autoreleasepool
    {
        [] (::id handle, float r, float g, float b, float a, int32_t layerIndex, ::id pathHandle, bool isLine, float strokeWidth, float opacity) -> void
        {
            UIControl* uicontrol = [(ShapeView*)handle shapeView];
...
void Shape::SetLinearGradient1(::g::ObjC::Object* handle, int32_t layerIndex, ::g::ObjC::Object* pathHandle, bool isLine, float strokeWidth, float startX, float startY, float endX, float endY, uArray* colors, uArray* offsets, float width, float height)
{
    @autoreleasepool
    {
        [] (::id handle, int32_t layerIndex, ::id pathHandle, bool isLine, float strokeWidth, float startX, float startY, float endX, float endY, id<UnoArray> colors, id<UnoArray> offsets, float width, float height) -> void
        {
            UIControl* uicontrol = [(ShapeView*)handle shapeView];
            UIBezierPath* path = (UIBezierPath*)pathHandle;
            CAShapeLayer* layer = (CAShapeLayer*)([[uicontrol layer] sublayers][layerIndex]);
            ...
            auto gradientStops = [&]() -> int32_t { ::uForeignPool __foreignPool; return uCast<uArray*>((offsets).unoArray, ::g::Uno::Float_typeof()->Array())->Length(); }();
