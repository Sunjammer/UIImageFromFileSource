...
// /usr/local/share/uno/Packages/Uno.Threading/1.6.0/AutoResetEvent.uno
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/1.6.0/Tasks/Tasks.uno
// -----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/1.6.0/Future.uno
// ------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/1.6.0/ConcurrentDictionary.uno
// --------------------------------------------------------------------------
...
{
    ::TYPES[0] = ::g::Uno::Collections::KeyValuePair_typeof();
    ::TYPES[1] = ::g::Uno::Collections::ICollection_typeof();
    ::TYPES[2] = ::g::Uno::Collections::List__Enumerator_typeof();
    ::TYPES[3] = ::g::Uno::Collections::List_typeof();
    type->SetPrecalc(
    ...
    type->SetInterfaces(
        ...
        ::TYPES[1/*Uno.Collections.ICollection`1*/]->MakeType(::TYPES[0/*Uno.Collections.KeyValuePair`2*/]->MakeType(type->T(0), type->T(1), NULL), NULL), offsetof(ConcurrentDictionary_type, interface1),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::TYPES[0/*Uno.Collections.KeyValuePair`2*/]->MakeType(type->T(0), type->T(1), NULL), NULL), offsetof(ConcurrentDictionary_type, interface2));
    type->SetFields(0,
        ::g::Uno::Collections::Dictionary_typeof()->MakeType(type->T(0), type->T(1), NULL), offsetof(ConcurrentDictionary, _dictionary), 0,
...
{
    uType* __types[] = {
        __this->__type->Precalced(2/*Uno.Collections.KeyValuePair<TKey, TValue>*/),
        __this->__type->Precalced(1/*Uno.Collections.ICollection<Uno.Collections.KeyValuePair<TKey, TValue>>*/),
    };
...
{
    uType* __types[] = {
        __type->Precalced(0/*Uno.Collections.List<Uno.Collections.KeyValuePair<TKey, TValue>>.Enumerator*/),
        __type->Precalced(3/*Uno.Collections.List<Uno.Collections.KeyValuePair<TKey, TValue>>*/),
    };
...
// /usr/local/share/uno/Packages/Uno.Threading/1.6.0/ConcurrentQueue.uno
// ---------------------------------------------------------------------
...
{
    ::TYPES[4] = ::g::Uno::Collections::Queue_typeof();
    type->SetPrecalc(
        ::g::Uno::Collections::Queue_typeof()->MakeType(type->T(0), NULL));
    type->SetFields(0,
        ::TYPES[4/*Uno.Collections.Queue`1*/]->MakeType(type->T(0), NULL), offsetof(ConcurrentQueue, _queue), 0,
...
// /usr/local/share/uno/Packages/Uno.Threading/1.6.0/ThreadPool.uno
// ----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/1.6.0/EventWaitHandle.uno
// ---------------------------------------------------------------------
...
void Future1__Invoke_fn(Future1* __this, uType* __type, uDelegate* action, void* arg)
{
    ...
    ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(__this->_dispatcher), ::g::Uno::Threading::IDispatcher_typeof()), uDelegate::New(::TYPES[10/*Uno.Action*/], (void*)Future1__Closure__Run_fn, (Future1__Closure__New1_fn(__types[0], action, arg, &ret7), ret7)));
}
...
void Future1::ctor_2(uObject* dispatcher)
{
    ...
    State(0);
    _catchables = ((::g::Uno::Collections::Queue*)::g::Uno::Collections::Queue::New1(::TYPES[4/*Uno.Collections.Queue`1*/]->MakeType(::g::Uno::Action1_typeof()->MakeType(::TYPES[6/*Uno.Exception*/], NULL), NULL)));
...
// /usr/local/share/uno/Packages/Uno.Threading/1.6.0/FutureState.uno
// -----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/1.6.0/IDispatcher.uno
// -----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/1.6.0/ManualResetEvent.uno
// ----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.6.0/Source/Uno/Threading/Monitor.uno
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/1.6.0/Mutex.uno
// -----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/1.6.0/Implementation/Posix/PthreadHelpers.uno
// -----------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/1.6.0/Promise.uno
// -------------------------------------------------------------
...
{
    ::TYPES[5] = ::g::Uno::Threading::TaskFuture_typeof();
...
// /usr/local/share/uno/Packages/Uno.Threading/1.6.0/SyncDispatcher.uno
// --------------------------------------------------------------------
...
static void Task_build(uType* type)
{
    ...
    ::TYPES[7] = ::TYPES[6/*Uno.Exception*/]->Array();
    ::TYPES[8] = ::g::Uno::Threading::ITaskScheduler_typeof();
    type->SetInterfaces(
...
{
    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            Status(1);
            Exception(::g::Uno::AggregateException::New7(uArray::Init< ::g::Uno::Exception*>(::TYPES[7/*Uno.Exception[]*/], 1, e)));
...
Task* Task::Run1(uDelegate* taskDelegate, uObject* scheduler)
{
    ...
    ::g::Uno::Threading::ITaskScheduler::ScheduleTask(uInterface(uPtr(scheduler), ::TYPES[8/*Uno.Threading.ITaskScheduler*/]), task);
    return task;
}
// }
...
{
    ::TYPES[9] = ::g::Uno::Threading::TaskDelegate_typeof();
    ::TYPES[6] = ::g::Uno::Exception_typeof();
    type->SetBase(::g::Uno::Threading::Future1_typeof()->MakeType(type->T(0), NULL));
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Uno::Threading::Future_type, interface0));
...
void TaskFuture::ctor_3(uDelegate* func)
{
    ctor_1();
    _func = func;
    _task = ::g::Uno::Threading::Task::Run(uDelegate::New(::TYPES[9/*Uno.Threading.TaskDelegate*/], (void*)TaskFuture__Invoke1_fn, this));
}
...
// /usr/local/share/uno/Packages/Uno.Threading/1.6.0/Thread.uno
// ------------------------------------------------------------
...
static void ThreadPoolTaskScheduler_build(uType* type)
{
    ...
    ::TYPES[11] = ::g::Uno::Platform::ApplicationStateTransitionHandler_typeof();
...
ThreadPoolTaskScheduler* ThreadPoolTaskScheduler::Default()
{
    if (ThreadPoolTaskScheduler::_default_ == NULL)
    {
        ...
        ::g::Uno::Platform::CoreApp::add_Terminating(uDelegate::New(::TYPES[11/*Uno.Platform.ApplicationStateTransitionHandler*/], (void*)ThreadPoolTaskScheduler__OnAppTerminating_fn));
    }
