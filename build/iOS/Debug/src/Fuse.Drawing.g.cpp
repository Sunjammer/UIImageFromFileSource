...
// /usr/local/share/uno/Packages/Fuse.Drawing/1.6.0/Blitter.uno
// ------------------------------------------------------------
...
static void Blitter_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[0/*float2[]*/], offsetof(Blitter, Blit_verts_963e11b4_1_7_7), 0,
...
{
    uArray* verts_963e11b4_1_7_0 = uArray::Init< ::g::Uno::Float2>(::TYPES[0/*float2[]*/], 6, ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(1.0f, 0.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(0.0f, 1.0f));
...
// /usr/local/share/uno/Packages/Fuse.Drawing/1.6.0/Brush.uno
// ----------------------------------------------------------
...
static void Brush_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing/1.6.0/Brush.uno");
...
// /usr/local/share/uno/Packages/Fuse.Drawing/1.6.0/Colors.uno
// -----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.6.0/CoreGraphics/CoreGraphicsSurface.uno
// ---------------------------------------------------------------------------------------------
...
static void CoreGraphicsSurface_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.6.0/CoreGraphics/CoreGraphicsSurface.uno");
...
::g::Uno::Float2 CoreGraphicsSurface::AddSegments(void* path, uObject* segments, ::g::Uno::Float2 prevPoint)
{
    ...
    for (int32_t i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(segments), ::TYPES[4/*Uno.Collections.ICollection<Fuse.Drawing.LineSegment>*/])); ++i)
    {
        ::g::Fuse::Drawing::LineSegment seg = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(segments), ::TYPES[5/*Uno.Collections.IList<Fuse.Drawing.LineSegment>*/]), uCRef<int32_t>(i), &ret4), ret4);
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.6.0/DrawObjectWatcher.uno
// ------------------------------------------------------------------------------
...
void DrawObjectWatcher::Sync()
{
    if (!_rooted)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Sync while not rooted"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.6.0/DrawObjectWatcher.uno"), 39, uString::Const("Sync"));
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.6.0/Drawing/ImageFill.uno
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing/1.6.0/Enums.uno
// ----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing/1.6.0/Brushes/LinearGradient.uno
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.6.0/CoreGraphics/GraphicsSurface.uno
// -----------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.6.0/SurfaceManager.uno
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing/1.6.0/Brushes/SolidColor.uno
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.6.0/Surface.uno
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.6.0/LineMetrics.uno
// ------------------------------------------------------------------------
...
::g::Uno::Rect LineMetricsImpl::GetBounds(uObject* segments)
{
    ...
    for (int32_t i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(segments), ::TYPES[4/*Uno.Collections.ICollection<Fuse.Drawing.LineSegment>*/])); ++i)
    {
        ::g::Fuse::Drawing::LineSegment cur = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(segments), ::TYPES[5/*Uno.Collections.IList<Fuse.Drawing.LineSegment>*/]), uCRef<int32_t>(i), &ret2), ret2);
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.6.0/LineSegment.uno
// ------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.6.0/LineSegments.uno
// -------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.6.0/CoreGraphics/NativeSurface.uno
// ---------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing/1.6.0/Stroke.uno
// -----------------------------------------------------------
...
static void Surface_build(uType* type)
{
    ...
    ::STRINGS[40] = uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.6.0/Surface.uno");
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.6.0/SurfaceUtil.uno
// ------------------------------------------------------------------------
