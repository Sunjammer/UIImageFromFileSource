...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Busy.uno
// ----------------------------------------------------------
...
static void Busy_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Busy.uno");
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/BusyTask.uno
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/BusyTaskModule.uno
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Completed.uno
// ---------------------------------------------------------------
...
static void BusyTaskModule__ConstructorClosure_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/BusyTaskModule.uno");
...
// /usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.6.0/Triggers/ScrollRegion.uno
// --------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Trigger.uno
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/StateGroup.uno
// ----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Actions/Playback.uno
// ----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/ProgressAnimation.uno
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Timeline.uno
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/IValue.uno
// ------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.6.0/Triggers/LayoutAnimation.uno
// ------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/PulseTrigger.uno
// ------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/WhileFloat.uno
// ----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/KeyboardVisible.uno
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/RemovingAnimation.uno
// -----------------------------------------------------------------------
...
static void RemovingAnimation_build(uType* type)
{
    ...
    ::STRINGS[13] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/RemovingAnimation.uno");
...
void RemovingAnimation__FuseIBeginRemoveVisualListenerOnBeginRemoveVisual_fn(RemovingAnimation* __this, ::g::Fuse::PendingRemoveVisual* pr)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[12/*"Double remo...*/], __this, ::STRINGS[13/*"/usr/local/...*/], 49, ::STRINGS[14/*"Fuse.IBegin...*/]);
        return;
    }
...
void RemovingAnimation::OnDone()
{
    if (_args == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[15/*"Unexpected ...*/], this, ::STRINGS[13/*"/usr/local/...*/], 62, ::STRINGS[16/*"OnDone"*/]);
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.6.0/Triggers/Scrolled.ScriptClass.uno
// ----------------------------------------------------------------------------------------------
...
static void Scrolled_build(uType* type)
{
    ...
    ::STRINGS[19] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.6.0/Triggers/Scrolled.uno");
...
void Scrolled__OnRooted_fn(Scrolled* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[18/*"Scrolled co...*/], __this, ::STRINGS[19/*"/usr/local/...*/], 35, ::STRINGS[20/*"OnRooted"*/], NULL);
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.6.0/Triggers/Scrolled.uno
// ----------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/State.ScriptClass.uno
// -----------------------------------------------------------------------
...
static void State_build(uType* type)
{
    ...
    ::STRINGS[23] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/State.uno");
...
void State::Goto()
{
    if (_stateGroup == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"Cannot call...*/], NULL, ::STRINGS[23/*"/usr/local/...*/], 62, ::STRINGS[24/*"Goto"*/]);
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/StateGroup.ScriptClass.uno
// ----------------------------------------------------------------------------
...
void StateGroup::goto_(StateGroup* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("StateGroup.goto requires 1 argument"), n, uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/StateGroup.ScriptClass.uno"), 48, uString::Const("goto_"), NULL);
        return;
    }
...
void StateGroup::gotoName(StateGroup* n, uString* name)
{
    ...
    if (state == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(uString::Const("Unable to find State with Name: "), name), n, uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/StateGroup.ScriptClass.uno"), 28, uString::Const("gotoName"), NULL);
        return;
    }
...
void Timeline::playTo(Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Timeline.playTo requires 1 argument"), n, uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Timeline.ScriptClass.uno"), 67, uString::Const("playTo"), NULL);
        return;
    }
...
void Timeline::seek(Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Timeline.seek requires 1 argument"), n, uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Timeline.ScriptClass.uno"), 116, uString::Const("seek"), NULL);
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/Transition.uno
// ---------------------------------------------------------------------------
...
static void TransitionGroup_build(uType* type)
{
    ...
    ::STRINGS[26] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/Transition.uno");
...
TransitionGroup* TransitionGroup::Root(::g::Fuse::Triggers::Transition* t)
{
    ...
    if (nav == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[25/*"Transition ...*/], t, ::STRINGS[26/*"/usr/local/...*/], 26, ::STRINGS[27/*"Root"*/], NULL);
        return NULL;
    }
    ...
    if (vis == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[28/*"Transition ...*/], t, ::STRINGS[26/*"/usr/local/...*/], 33, ::STRINGS[27/*"Root"*/], NULL);
        return NULL;
    }
...
void Trigger__FuseAnimationsIBasePlayerFeedbackOnPlaybackDone_fn(Trigger* __this, uObject* s)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Trigger.OnPlaybackdone called with _animState == null"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Trigger.uno"), 303, uString::Const("Fuse.Animations.IBasePlayerFeedback.OnPlaybackDone"));
        return;
    }
...
void Trigger::Bypass(int32_t value)
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(uString::Const("ExceptLayout mode indicates a problem in trigger expecations and should no tbe used"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/Trigger.uno"), 110, uString::Const("set_Bypass"));
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/WhileBool.uno
// ---------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/WhilePlaying.uno
// ------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/WhileString.uno
// -----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/WhileTrigger.uno
// ------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/WhileValue.uno
// ----------------------------------------------------------------
...
static void WhileValue_build(uType* type)
{
    ...
    ::STRINGS[30] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.6.0/WhileValue.uno");
...
void WhileValue::Pulse1()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[29/*"`Pulse` on ...*/], this, ::STRINGS[30/*"/usr/local/...*/], 47, ::STRINGS[31/*"Pulse"*/]);
