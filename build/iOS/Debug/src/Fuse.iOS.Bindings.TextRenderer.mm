...
// internal sealed extern class TextRenderer :189
// {
// static generated TextRenderer() :189
...
// public TextRenderer(Fuse.Controls.TextControl control) :204
...
// private static Fuse.iOS.Bindings.CGColorSpaceRef CGColorSpaceCreateDeviceRGB() :193
...
// internal static Fuse.Controls.ITextRenderer Create(Fuse.Controls.TextControl control) :195
void TextRenderer__Create_fn(::g::Fuse::Controls::TextControl* control, uObject** __retval)
{
    *__retval = TextRenderer::Create(control);
}

// public void Draw(Fuse.DrawContext dc, Fuse.Visual where) :225
...
// public float2 GetContentSize(Fuse.LayoutParams lp) :209
...
// public TextRenderer New(Fuse.Controls.TextControl control) :204
...
// public TextRenderer(Fuse.Controls.TextControl control) [instance] :204
...
// public void Draw(Fuse.DrawContext dc, Fuse.Visual where) [instance] :225
void TextRenderer::Draw(::g::Fuse::DrawContext* dc, ::g::Fuse::Visual* where)
{
    ...
    uPtr(::g::Fuse::Drawing::Blitter::Singleton())->Blit1(_texture, ::g::Uno::Rect__New2(pointPosition, pointSize), uPtr(dc)->GetLocalToClipTransform(where), 1.0f, true, 0);
}

// public float2 GetContentSize(Fuse.LayoutParams lp) [instance] :209
...
// private static Fuse.iOS.Bindings.CGColorSpaceRef CGColorSpaceCreateDeviceRGB() [static] :193
...
// internal static Fuse.Controls.ITextRenderer Create(Fuse.Controls.TextControl control) [static] :195
...
// public TextRenderer New(Fuse.Controls.TextControl control) [static] :204
