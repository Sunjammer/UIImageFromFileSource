#!/bin/bash
# This file was generated based on /usr/local/share/uno/Packages/UnoCore/1.6.0/Targets/iOS/build.sh.
...
##else
    xcodebuild -project "UIImageFromBundle.xcodeproj" "$@" | tee >(checkForError)
##endif
