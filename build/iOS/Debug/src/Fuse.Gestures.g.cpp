...
// /usr/local/share/uno/Packages/Fuse.Gestures/1.6.0/Internal/Helpers.uno
// ----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Gestures/1.6.0/WhileEdgeSwiped.uno
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Gestures/1.6.0/KeepInView.uno
// ----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.6.0/Scroller.uno
// -------------------------------------------------------------------------
...
{
    _delayStart = value;
    ::g::Fuse::Diagnostics::Deprecated(uString::Const("Scroller.DelayStart is no longer supported."), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.6.0/Scroller.uno"), 49, uString::Const("set_DelayStart"));
}
...
void Scroller::OnUpdated()
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Invalid scroller update"), NULL, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.6.0/Scroller.uno"), 384, uString::Const("OnUpdated"));
        return;
    }
...
void Scroller::UpdatePointerEvents(bool forceOff)
{
    ...
    {
        if (_gesture != NULL)
            ::g::Fuse::Diagnostics::InternalError(uString::Const("inconsistent gesture state"), NULL, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.6.0/Scroller.uno"), 129, uString::Const("UpdatePointerEvents"));
        else
    ...
    {
        if (_gesture == NULL)
            ::g::Fuse::Diagnostics::InternalError(uString::Const("inconsistent gesture state"), NULL, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.6.0/Scroller.uno"), 136, uString::Const("UpdatePointerEvents"));
        else
        {
...
// /usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.6.0/Scroller.Actions.uno
// ---------------------------------------------------------------------------------
...
static void ScrollTo_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.6.0/Scroller.Actions.uno");
    ::STRINGS[2] = uString::Const("Perform");
    ::TYPES[4] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Controls.ScrollView>*/, ::g::Fuse::Controls::ScrollView_typeof(), NULL);
    type->SetFields(8,
...
void ScrollTo__Perform_fn(ScrollTo* __this, ::g::Fuse::Node* target)
{
    ...
    ind1 = __this->Target();
    ::g::Fuse::Controls::ScrollView* scrollView = (ind1 != NULL) ? ind1 : (::g::Fuse::Controls::ScrollView*)uPtr(target)->FindByType(::TYPES[4/*Fuse.Node.FindByType<Fuse.Controls.ScrollView>*/]);
...
// /usr/local/share/uno/Packages/Fuse.Gestures/1.6.0/Swipe.uno
// -----------------------------------------------------------
...
{
    ::TYPES[5] = ::g::Uno::Action2_typeof()->MakeType(::g::Uno::Bool_typeof(), ::g::Uno::Bool_typeof(), NULL);
    type->SetInterfaces(
...
static void SwipeGesture_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("/usr/local/share/uno/Packages/Fuse.Gestures/1.6.0/Swipe.uno");
