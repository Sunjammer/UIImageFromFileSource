...
// /usr/local/share/uno/Packages/Fuse.FileSystem/1.6.0/FileSystemOperations.uno
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.FileSystem/1.6.0/FileSystemModule.uno
// ------------------------------------------------------------------------
...
static void FileSystemModule_build(uType* type)
{
    ...
    ::TYPES[25] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(7/*ToArray<object>*/, uObject_typeof(), NULL);
...
{
    return (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[26/*Uno.Collections.EnumerableExtensions*/]->MakeMethod(7/*ToArray<string>*/, ::TYPES[24/*string*/], NULL), (uObject*)::g::Uno::Collections::EnumerableExtensions::Select(::TYPES[26/*Uno.Collections.EnumerableExtensions*/]->MakeMethod(5/*Select<string, string>*/, ::TYPES[24/*string*/], ::TYPES[24/*string*/], NULL), ::g::Uno::IO::Directory::EnumerateDirectories(path), uDelegate::New(::g::Uno::Func1_typeof()->MakeType(::TYPES[24/*string*/], ::TYPES[24/*string*/], NULL), (void*)::g::Fuse::FileSystem::PathTools__NormalizePath_fn)));
}
...
// /usr/local/share/uno/Packages/Fuse.FileSystem/1.6.0/Nothing.uno
// ---------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.FileSystem/1.6.0/PathTools.uno
// -----------------------------------------------------------------
