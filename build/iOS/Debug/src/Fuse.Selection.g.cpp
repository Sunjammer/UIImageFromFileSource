...
// /usr/local/share/uno/Packages/Fuse.Selection/1.6.0/Selection.uno
// ----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Selection/1.6.0/Selectable.ScriptClass.uno
// -----------------------------------------------------------------------------
...
static void Selectable_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.6.0/Selectable.uno");
...
void Selectable__OnRooted_fn(Selectable* __this)
{
    ...
    if (__this->_selection == NULL)
        ::g::Fuse::Diagnostics::UserError(::STRINGS[7/*"Unable to l...*/], __this, ::STRINGS[5/*"/usr/local/...*/], 41, ::STRINGS[8/*"OnRooted"*/], NULL);
}
...
void Selectable::Add1()
{
    if (_selection == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[4/*"No selectio...*/], this, ::STRINGS[5/*"/usr/local/...*/], 82, ::STRINGS[6/*"Add"*/], NULL);
        return;
    }
...
void Selectable::Remove1()
{
    if (_selection == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[4/*"No selectio...*/], this, ::STRINGS[5/*"/usr/local/...*/], 96, ::STRINGS[9/*"Remove"*/], NULL);
        return;
    }
...
void Selectable::Toggle()
{
    if (_selection == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[4/*"No selectio...*/], this, ::STRINGS[5/*"/usr/local/...*/], 110, ::STRINGS[10/*"Toggle"*/], NULL);
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Selection/1.6.0/Selection.ScriptClass.uno
// ----------------------------------------------------------------------------
...
void Selection__FuseReactiveIObserverOnFailed_fn(Selection* __this, uString* message)
{
    ...
    ::g::Fuse::Diagnostics::InternalError(message, __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.6.0/Selection.uno"), 495, uString::Const("Fuse.Reactive.IObserver.OnFailed"));
}
...
void Selection__FuseReactiveIObserverOnInsertAt_fn(Selection* __this, int32_t* index, uObject* value)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("removing invalid observable item"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.6.0/Selection.uno"), 485, uString::Const("Fuse.Reactive.IObserver.OnInsertAt"));
        return;
    }
...
void Selection__FuseReactiveIObserverOnNewAt_fn(Selection* __this, int32_t* index, uObject* newValue)
{
    ...
    if ((index_ < 0) || (index_ >= uPtr(__this->_values)->Count()))
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("removing invalid observable item"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.6.0/Selection.uno"), 450, uString::Const("Fuse.Reactive.IObserver.OnNewAt"));
        return;
    }
...
void Selection__FuseReactiveIObserverOnRemoveAt_fn(Selection* __this, int32_t* index)
{
    ...
    if ((index_ < 0) || (index_ >= uPtr(__this->_values)->Count()))
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("removing invalid observable item"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.6.0/Selection.uno"), 474, uString::Const("Fuse.Reactive.IObserver.OnRemoveAt"));
        return;
    }
...
void Selection::MaxCount(int32_t value)
{
    ...
    if (value < 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("MaxCount must >= 1"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.6.0/Selection.uno"), 138, uString::Const("set_MaxCount"), NULL);
        return;
    }
...
void Selection::OnSelectionChanged(int32_t how)
{
    if ((how == 0) && (_subscription != NULL))
    {
        ...
        if (sub != NULL)
            ...
            ::g::Fuse::Diagnostics::UserWarning(uString::Const("Selection changed, but the bound collection is not writeable."), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.6.0/Selection.uno"), 356, uString::Const("OnSelectionChanged"));
    }
...
void Selection::add(Selection* s, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("add requires 1 argument, the value of the item"), s, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.6.0/Selection.ScriptClass.uno"), 43, ::STRINGS[1/*"add"*/], NULL);
        return;
    }
...
void Selection::forceAdd(Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("forceAdd requires 1 argument, the value of the item"), s, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.6.0/Selection.ScriptClass.uno"), 75, uString::Const("forceAdd"), NULL);
        return;
    }
...
void Selection::forceRemove(Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("forceRemove requires 1 argument, the value of the item"), s, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.6.0/Selection.ScriptClass.uno"), 89, uString::Const("forceRemove"), NULL);
        return;
    }
...
void Selection::remove(Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("remove requires 1 argument, the value of the item"), s, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.6.0/Selection.ScriptClass.uno"), 61, ::STRINGS[2/*"remove"*/], NULL);
        return;
    }
...
void Selection::toggle(Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("toggle requires 1 argument, the value of them item"), s, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.6.0/Selection.ScriptClass.uno"), 105, ::STRINGS[3/*"toggle"*/], NULL);
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Selection/1.6.0/ToggleSelection.uno
// ----------------------------------------------------------------------
...
static void ToggleSelection_build(uType* type)
{
    ...
    ::STRINGS[12] = uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.6.0/ToggleSelection.uno");
...
void ToggleSelection__Perform_fn(ToggleSelection* __this, ::g::Fuse::Node* target)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[11/*"Unable to l...*/], __this, ::STRINGS[12/*"/usr/local/...*/], 46, ::STRINGS[13/*"Perform"*/], NULL);
        return;
    }
