...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.6.0/Observable.uno
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.6.0/TreeObservable/TreeObservable.uno
// -----------------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.6.0/ArrayMirror.uno
// -----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.6.0/TreeObservable/TreeArray.uno
// ------------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.6.0/ClassInstance.uno
// -------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.6.0/ThreadWorker.uno
// ------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.6.0/DateTimeConverterHelpers.uno
// ------------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.6.0/Context.uno
// -------------------------------------------------------------------------
...
{
    if (context != __this)
        ::g::Fuse::Diagnostics::InternalError(uString::Const("IMirror.Reflect with inconsistent context"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.6.0/Context.uno"), 94, uString::Const("Fuse.Scripting.JavaScript.IMirror.Reflect"));
...
uObject* JSContext::CreateMirror(uObject* obj)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserWarning(uString::Const("JavaScript data model contains circular references or is too deep. Some data may not display correctly."), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.6.0/Context.uno"), 103, uString::Const("CreateMirror"));
        return NULL;
    }
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.6.0/TreeObservable/TreeObject.uno
// -------------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.6.0/ObservableProperty.uno
// ------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.6.0/ModuleInstance.uno
// --------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.6.0/ObjectMirror.uno
// ------------------------------------------------------------------------------
...
static void ObjectMirror_build(uType* type)
{
    ...
    ::TYPES[32] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(7/*ToArray<string>*/, ::g::Uno::String_typeof(), NULL);
    type->SetInterfaces(
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.6.0/RootableScriptModule.uno
// --------------------------------------------------------------------------------------
...
void Observable__Subscription__FuseReactiveISubscriptionSetExclusive_fn(Observable__Subscription* __this, uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Unexpected null object"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.6.0/Observable.uno"), 132, uString::Const("Fuse.Reactive.ISubscription.SetExclusive"));
        return;
    }
...
void Observable__Subscription::SetExclusive(::g::Fuse::Scripting::Context* context, uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Unexpected null object"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.6.0/Observable.uno"), 118, uString::Const("SetExclusive"));
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.6.0/TypeWrapper.uno
// -----------------------------------------------------------------------------
