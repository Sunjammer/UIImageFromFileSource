...
// /usr/local/share/uno/Packages/Fuse.Controls/1.6.0/.uno/package
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.6.0/.uno/ux13/Fuse.Controls.Navigation.unoproj.g.uno
// -------------------------------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.6.0/.uno/ux13/Fuse.Controls.Primitives.unoproj.g.uno
// -------------------------------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.6.0/.uno/ux13/Fuse.Controls.ScrollView.unoproj.g.uno
// -------------------------------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Video/1.6.0/.uno/package
// --------------------------------------------------------------------
...
static void FuseControlsVideo_bundle_build(uType* type)
{
    ::STRINGS[27] = uString::Const("uniform float c, d, e, f, g, h, k, l, m, n;\n"
        ...
        "}\n"
        "");
    ::STRINGS[28] = uString::Const("uniform sampler2D q;\n"
        "\n"
        "varying vec2 p;\n"
        "\n"
        "void main()\n"
    ...
    ::STRINGS[29] = uString::Const("uniform mat4 f, c;\n"
        ...
        "}\n"
        "");
    ::STRINGS[30] = uString::Const("uniform sampler2D h;\n"
        "\n"
        "varying vec2 g;\n"
        "\n"
        "void main()\n"
...
// /usr/local/share/uno/Packages/Fuse.Drawing/1.6.0/.uno/package
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Primitives/1.6.0/.uno/package
// ------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.6.0/.uno/package
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Effects/1.6.0/.uno/package
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.6.0/.uno/package
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/1.6.0/.uno/package
// --------------------------------------------------------
...
{
    UnoCore_bundle::SdfFontShaderc4d110ba_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[139/*"uniform mat...*/], ::STRINGS[140/*"uniform flo...*/], 0, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[4/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[3/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[10/*"i"*/]));
    UnoCore_bundle::SpriteFontShader901b6a86_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[141/*"uniform mat...*/], ::STRINGS[142/*"uniform sam...*/], 0, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[4/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[3/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"g"*/]));
}

static void UnoCore_bundle_build(uType* type)
{
    ::STRINGS[139] = uString::Const("uniform mat4 d;\n"
        "\n"
        "attribute vec2 a, b;\n"
        "attribute vec4 c;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[140] = uString::Const("uniform float e, f;\n"
        "\n"
        "uniform sampler2D i;\n"
        "\n"
        "varying vec2 g;\n"
    ...
    ::STRINGS[7] = uString::Const("f");
    ::STRINGS[10] = uString::Const("i");
    ::STRINGS[141] = uString::Const("uniform mat4 d;\n"
        "\n"
        "attribute vec2 a, c;\n"
        "attribute vec4 b;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[142] = uString::Const("uniform sampler2D g;\n"
        "\n"
        "varying vec2 e;\n"
        "varying vec4 f;\n"
        "\n"
